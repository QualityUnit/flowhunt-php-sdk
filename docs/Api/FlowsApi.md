...
| [**getArtefactContent()**](FlowsApi.md#getArtefactContent) | **GET** /v2/flows/sessions/{session_id}/artefacts/{artefact_id} | Get artefact content |
...
| [**resumeHook()**](FlowsApi.md#resumeHook) | **POST** /v2/flows/sessions/{session_id}/resume-hook | Resume Hook |
...
```php
cancelFlowSession($session_id): \FlowHunt\Model\Completed
```
...
try {
    $result = $apiInstance->cancelFlowSession($session_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FlowsApi->cancelFlowSession: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
downloadAttachment($session_id, $file_id): mixed
```
...
try {
    $result = $apiInstance->downloadAttachment($session_id, $file_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FlowsApi->downloadAttachment: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getArtefactContent($session_id, $artefact_id): \FlowHunt\Model\FlowSessionArtefactContentResponse
```
...
try {
    $result = $apiInstance->getArtefactContent($session_id, $artefact_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FlowsApi->getArtefactContent: ', $e->getMessage(), PHP_EOL;
}
```
...
[**\FlowHunt\Model\FlowSessionArtefactContentResponse**](../Model/FlowSessionArtefactContentResponse.md)
...
```php
resumeHook($session_id, $flow_session_resume_hook_request): \FlowHunt\Model\Completed
```
...
$session_id = 'session_id_example'; // string
$flow_session_resume_hook_request = new \FlowHunt\Model\FlowSessionResumeHookRequest(); // \FlowHunt\Model\FlowSessionResumeHookRequest

try {
    $result = $apiInstance->resumeHook($session_id, $flow_session_resume_hook_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FlowsApi->resumeHook: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **session_id** | **string**|  | |
| **flow_session_resume_hook_request** | [**\FlowHunt\Model\FlowSessionResumeHookRequest**](../Model/FlowSessionResumeHookRequest.md)|  | |
