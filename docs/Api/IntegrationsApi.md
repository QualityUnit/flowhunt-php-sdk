...
| ------------- | ------------- | ------------- |
| [**adminUi()**](IntegrationsApi.md#adminUi) | **POST** /v2/integrations/zendesk_channel/admin_ui | Admin Ui |
| [**channelback()**](IntegrationsApi.md#channelback) | **POST** /v2/integrations/zendesk_channel/channelback | Channelback |
...
| [**deleteJiraWebhook()**](IntegrationsApi.md#deleteJiraWebhook) | **DELETE** /v2/integrations/atlassian/jira/webhooks/{webhook_id} | Delete Jira Webhook |
| [**eventsCallback()**](IntegrationsApi.md#eventsCallback) | **POST** /v2/integrations/zendesk_channel/events | Events Callback |
...
| [**getJiraIssues()**](IntegrationsApi.md#getJiraIssues) | **GET** /v2/integrations/atlassian/jira/projects/{project_key}/issues | Get Jira Issues |
| [**getJiraProjects()**](IntegrationsApi.md#getJiraProjects) | **GET** /v2/integrations/atlassian/jira/projects | Get Jira Projects |
...
| [**listJiraWebhooks()**](IntegrationsApi.md#listJiraWebhooks) | **GET** /v2/integrations/atlassian/jira/webhooks | List Jira Webhooks |
| [**listZendeskKbCategories()**](IntegrationsApi.md#listZendeskKbCategories) | **GET** /v2/integrations/zendesk/kb/categories | List Zendesk Kb Categories |
| [**listZendeskKbLabels()**](IntegrationsApi.md#listZendeskKbLabels) | **GET** /v2/integrations/zendesk/kb/labels | List Zendesk Kb Labels |
| [**listZendeskKbSections()**](IntegrationsApi.md#listZendeskKbSections) | **GET** /v2/integrations/zendesk/kb/sections | List Zendesk Kb Sections |
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->adminUi: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->channelback: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
createIntegration($slug, $workspace_id, $redirect_uri): \FlowHunt\Model\IntegrationFlowResponse
```
...
try {
    $result = $apiInstance->createIntegration($slug, $workspace_id, $redirect_uri);
    print_r($result);
} catch (Exception $e) {
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->deleteJiraWebhook: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->eventsCallback: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->getAirtableBases: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->getAirtableTables: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->getBranches: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->getClickupSpaces: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->getClickupWorkspaces: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->getConfluencePages: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->getConfluenceSpaces: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->getJiraAssignees: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->getJiraIssues: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->getJiraProjects: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->getJiraTransitions: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->getProjects: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->listJiraWebhooks: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->listZendeskKbCategories: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->listZendeskKbLabels: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->listZendeskKbSections: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->manifest: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->messagingWebhook: ', $e->getMessage(), PHP_EOL;
}
```
...
try {
    ...
    echo 'Exception when calling IntegrationsApi->messagingWebhookHead: ', $e->getMessage(), PHP_EOL;
}
```
