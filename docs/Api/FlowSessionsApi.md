...
| [**searchFlowEvent()**](FlowSessionsApi.md#searchFlowEvent) | **POST** /v2/chatbots/sessions/search_event | Search Flow Event |
...
```php
searchFlowEvent($workspace_id, $flow_events_search_request): \FlowHunt\Model\FlowEventsSearchResponse[]
```
...
$workspace_id = 'workspace_id_example'; // string
$flow_events_search_request = new \FlowHunt\Model\FlowEventsSearchRequest(); // \FlowHunt\Model\FlowEventsSearchRequest

try {
    $result = $apiInstance->searchFlowEvent($workspace_id, $flow_events_search_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FlowSessionsApi->searchFlowEvent: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **workspace_id** | **string**|  | |
| **flow_events_search_request** | [**\FlowHunt\Model\FlowEventsSearchRequest**](../Model/FlowEventsSearchRequest.md)|  | |

### Return type

[**\FlowHunt\Model\FlowEventsSearchResponse[]**](../Model/FlowEventsSearchResponse.md)
