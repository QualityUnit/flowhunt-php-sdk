...
| [**deleteAgentGridRow()**](AgentGridsApi.md#deleteAgentGridRow) | **DELETE** /v2/agent_grids/{agent_grid_id}/rows/{row_id} | Delete a row |
...
| [**importAgentGridCsv()**](AgentGridsApi.md#importAgentGridCsv) | **POST** /v2/agent_grids/{agent_grid_id}/import-csv | Import CSV |
...
```php
deleteAgentGridRow($agent_grid_id, $row_id, $workspace_id): \FlowHunt\Model\Completed
```
...
try {
    $result = $apiInstance->deleteAgentGridRow($agent_grid_id, $row_id, $workspace_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AgentGridsApi->deleteAgentGridRow: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
importAgentGridCsv($agent_grid_id, $workspace_id, $file): \FlowHunt\Model\AgentGridImportStartResponse
```
...
$agent_grid_id = 'agent_grid_id_example'; // string
$workspace_id = 'workspace_id_example'; // string
$file = 'file_example'; // string | CSV file to import

try {
    $result = $apiInstance->importAgentGridCsv($agent_grid_id, $workspace_id, $file);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AgentGridsApi->importAgentGridCsv: ', $e->getMessage(), PHP_EOL;
}
```
...
| **agent_grid_id** | **string**|  | |
| **workspace_id** | **string**|  | |
| **file** | **string**| CSV file to import | |
