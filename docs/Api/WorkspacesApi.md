...
```php
transferWorkspaceOwnership($workspace_id, $new_owner_user_id): \FlowHunt\Model\Completed
```
...
$workspace_id = 'workspace_id_example'; // string
$new_owner_user_id = 'new_owner_user_id_example'; // string

try {
    $result = $apiInstance->transferWorkspaceOwnership($workspace_id, $new_owner_user_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling WorkspacesApi->transferWorkspaceOwnership: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
updateWorkspaceCreditAlertThreshold($workspace_id, $workspace_credit_alert_threshold_request): \FlowHunt\Model\WorkspaceResponse
```
...
$workspace_id = 'workspace_id_example'; // string
$workspace_credit_alert_threshold_request = new \FlowHunt\Model\WorkspaceCreditAlertThresholdRequest(); // \FlowHunt\Model\WorkspaceCreditAlertThresholdRequest

try {
    $result = $apiInstance->updateWorkspaceCreditAlertThreshold($workspace_id, $workspace_credit_alert_threshold_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling WorkspacesApi->updateWorkspaceCreditAlertThreshold: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **workspace_id** | **string**|  | |
| **workspace_credit_alert_threshold_request** | [**\FlowHunt\Model\WorkspaceCreditAlertThresholdRequest**](../Model/WorkspaceCreditAlertThresholdRequest.md)|  | |
...
```php
updateWorkspaceCreditLimit($workspace_id, $workspace_credit_limit_request): \FlowHunt\Model\WorkspaceResponse
```

Update Workspace Credit Limit
...
$workspace_id = 'workspace_id_example'; // string
$workspace_credit_limit_request = new \FlowHunt\Model\WorkspaceCreditLimitRequest(); // \FlowHunt\Model\WorkspaceCreditLimitRequest

try {
    $result = $apiInstance->updateWorkspaceCreditLimit($workspace_id, $workspace_credit_limit_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling WorkspacesApi->updateWorkspaceCreditLimit: ', $e->getMessage(), PHP_EOL;
}
```
...
| ------------- | ------------- | ------------- | ------------- |
| **workspace_id** | **string**|  | |
| **workspace_credit_limit_request** | [**\FlowHunt\Model\WorkspaceCreditLimitRequest**](../Model/WorkspaceCreditLimitRequest.md)|  | |
