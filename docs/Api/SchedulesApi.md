...
```php
deleteScheduleUrl($schedule_id, $url_id, $domain_id, $workspace_id, $schedule_url_delete_request): \FlowHunt\Model\Completed
```
...
$workspace_id = 'workspace_id_example'; // string
$schedule_url_delete_request = new \FlowHunt\Model\ScheduleUrlDeleteRequest(); // \FlowHunt\Model\ScheduleUrlDeleteRequest

try {
    $result = $apiInstance->deleteScheduleUrl($schedule_id, $url_id, $domain_id, $workspace_id, $schedule_url_delete_request);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling SchedulesApi->deleteScheduleUrl: ', $e->getMessage(), PHP_EOL;
}
```
...
| **domain_id** | **string**|  | |
| **workspace_id** | **string**|  | |
| **schedule_url_delete_request** | [**\FlowHunt\Model\ScheduleUrlDeleteRequest**](../Model/ScheduleUrlDeleteRequest.md)|  | |
