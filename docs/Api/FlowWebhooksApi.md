...
| [**executeWebhookTriggerGet()**](FlowWebhooksApi.md#executeWebhookTriggerGet) | **GET** /v2/flows/webhooks/trigger/{webhook_id} | Execute Webhook Trigger Get |
| [**executeWebhookTriggerPost()**](FlowWebhooksApi.md#executeWebhookTriggerPost) | **POST** /v2/flows/webhooks/trigger/{webhook_id} | Execute Webhook Trigger Post |
| [**getInstallationMetadata()**](FlowWebhooksApi.md#getInstallationMetadata) | **GET** /v2/flows/webhooks/third_party_integrations/installation_metadata | Get Installation Metadata |
...
```php
executeWebhookTriggerGet($webhook_id, $workspace_id): mixed
```

Execute Webhook Trigger Get
...
try {
    $result = $apiInstance->executeWebhookTriggerGet($webhook_id, $workspace_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FlowWebhooksApi->executeWebhookTriggerGet: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
executeWebhookTriggerPost($webhook_id, $workspace_id): mixed
```

Execute Webhook Trigger Post
...
try {
    $result = $apiInstance->executeWebhookTriggerPost($webhook_id, $workspace_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FlowWebhooksApi->executeWebhookTriggerPost: ', $e->getMessage(), PHP_EOL;
}
```
...
```php
getInstallationMetadata($workspace_id, $flow_id, $app_id, $trigger_type): array<string,mixed>
```
...
try {
    $result = $apiInstance->getInstallationMetadata($workspace_id, $flow_id, $app_id, $trigger_type);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling FlowWebhooksApi->getInstallationMetadata: ', $e->getMessage(), PHP_EOL;
}
```
