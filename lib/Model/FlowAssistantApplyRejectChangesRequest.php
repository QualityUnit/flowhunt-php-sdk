...
/**
 * FlowAssistantApplyRejectChangesRequest Class Doc Comment
 *
 * @category Class
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 ...
 */
class FlowAssistantApplyRejectChangesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlowAssistantApplyRejectChangesRequest';
    ...
    */
     ...
     * Sets flow_id
     *
     * @param string $flow_id The Agent ID currently being enhanced by the AI Agent.
     *
     * @return self
     */
