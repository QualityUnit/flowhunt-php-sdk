...
class LoginUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LoginUserRequest';
    ...
    */
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) > 100)) {
            throw new \InvalidArgumentException('invalid length for $password when calling LoginUserRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($password) < 8)) {
            throw new \InvalidArgumentException('invalid length for $password when calling LoginUserRequest., must be bigger than or equal to 8.');
        }
