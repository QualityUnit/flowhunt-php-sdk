...
/**
 * MCPConnectorTestTool Class Doc Comment
 *
 * @category Class
 * @description One tool advertised by the connector&#39;s MCP server during a test connection. Trimmed to fields the UI actually displays.
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MCPConnectorTestTool implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MCPConnectorTestTool';
    ...
    */
     ...
     * Sets input_schema
     *
     * @param array<string,mixed>|null $input_schema input_schema
     *
     * @return self
     */
