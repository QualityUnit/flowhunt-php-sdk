...
class PromptResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'workspace_id' => 'mixed',
        'name' => 'mixed',
        'description' => '\OpenAPI\Client\Model\Description4',
        'prompt_text' => 'mixed',
        'prompt_url' => '\OpenAPI\Client\Model\PromptUrl'
    ];
    ...
    */
     ...
     * Sets prompt_id
     *
     * @param mixed $prompt_id Prompt ID
     *
     * @return self
     */
    public function setPromptId($prompt_id)
    {
        if (is_null($prompt_id)) {
            array_push($this->openAPINullablesSetToNull, 'prompt_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('prompt_id', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets description
     *
     * @return \OpenAPI\Client\Model\Description4|null
     */
     ...
     * Sets description
     *
     * @param \OpenAPI\Client\Model\Description4|null $description description
     *
     * @return self
     */
     ...
     * Sets prompt_text
     *
     * @param mixed $prompt_text Prompt text
     *
     * @return self
     */
    public function setPromptText($prompt_text)
    {
        if (is_null($prompt_text)) {
            array_push($this->openAPINullablesSetToNull, 'prompt_text');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('prompt_text', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets prompt_url
     *
     * @return \OpenAPI\Client\Model\PromptUrl|null
     */
     ...
     * Sets prompt_url
     *
     * @param \OpenAPI\Client\Model\PromptUrl|null $prompt_url prompt_url
     *
     * @return self
     */
