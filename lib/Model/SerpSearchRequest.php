...
class SerpSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'count_urls' => '\OpenAPI\Client\Model\CountUrls'
    ];
    ...
    */
     ...
     * Gets count_urls
     *
     * @return \OpenAPI\Client\Model\CountUrls|null
     */
     ...
     * Sets count_urls
     *
     * @param \OpenAPI\Client\Model\CountUrls|null $count_urls count_urls
     *
     * @return self
     */
    public function setCountUrls($count_urls)
    {
        if (is_null($count_urls)) {
            throw new \InvalidArgumentException('non-nullable count_urls cannot be null');
        }
