...
class ResultData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'artifacts' => 'AnyOf',
        'outputs' => 'object',
        'messages' => '\OpenAPI\Client\Model\ChatOutputResponse[]',
        'timedelta' => 'float',
        'duration' => 'string',
        'component_display_name' => 'string',
        'component_id' => 'string',
        'used_frozen_result' => 'bool'
    ];
    ...
    */
     ...
     * Sets results
     *
     * @param AnyOf|null $results results
     *
     * @return self
     */
     ...
     * Sets artifacts
     *
     * @param AnyOf|null $artifacts artifacts
     *
     * @return self
     */
    public function setArtifacts($artifacts)
    {
        if (is_null($artifacts)) {
            array_push($this->openAPINullablesSetToNull, 'artifacts');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('artifacts', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        if (is_null($outputs)) {
            array_push($this->openAPINullablesSetToNull, 'outputs');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('outputs', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets messages
     *
     * @return \OpenAPI\Client\Model\ChatOutputResponse[]|null
     */
     ...
     * Sets messages
     *
     * @param \OpenAPI\Client\Model\ChatOutputResponse[]|null $messages messages
     *
     * @return self
     */
     ...
     * Sets timedelta
     *
     * @param float|null $timedelta timedelta
     *
     * @return self
     */
    public function setTimedelta($timedelta)
    {
        if (is_null($timedelta)) {
            array_push($this->openAPINullablesSetToNull, 'timedelta');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('timedelta', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param bool|null $used_frozen_result used_frozen_result
     *
     * @return self
     */
    public function setUsedFrozenResult($used_frozen_result)
    {
        if (is_null($used_frozen_result)) {
            array_push($this->openAPINullablesSetToNull, 'used_frozen_result');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('used_frozen_result', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
