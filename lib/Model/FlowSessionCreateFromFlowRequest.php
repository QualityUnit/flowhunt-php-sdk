...
class FlowSessionCreateFromFlowRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'flow_branch' => '\FlowHunt\Model\FlowBranch'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('flow_branch', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets flow_id
     *
     * @param string $flow_id The agent ID
     *
     * @return self
     */
     ...
     */
    public function getFlowBranch()
    {
        return $this->container['flow_branch'];
    }

    /**
     * Sets flow_branch
     *
     * @param \FlowHunt\Model\FlowBranch|null $flow_branch The agent branch
     *
     * @return self
     */
    public function setFlowBranch($flow_branch)
    {
        if (is_null($flow_branch)) {
            throw new \InvalidArgumentException('non-nullable flow_branch cannot be null');
        }
        $this->container['flow_branch'] = $flow_branch;
