...
/**
 * WorkspaceSSOCreateRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class WorkspaceSSOCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WorkspaceSSOCreateRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('jit_provisioning_enabled', $data ?? [], null);
    ...
    */
     ...
     * Sets provider
     *
     * @param string $provider SSO provider (e.g., 'microsoft')
     *
     * @return self
     */
     ...
     * Sets idp_sso_url
     *
     * @param string|null $idp_sso_url Identity Provider SSO URL
     *
     * @return self
     */
    public function setIdpSsoUrl($idp_sso_url)
    {
        if (is_null($idp_sso_url)) {
            throw new \InvalidArgumentException('non-nullable idp_sso_url cannot be null');
        }
    ...
    public function setJitProvisioningEnabled($jit_provisioning_enabled)
    {
        if (is_null($jit_provisioning_enabled)) {
            array_push($this->openAPINullablesSetToNull, 'jit_provisioning_enabled');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('jit_provisioning_enabled', $nullablesSetToNull);
            if ($index !== FALSE) {
