...
class CreditDailyTransactionSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'grouping' => '\FlowHunt\Model\GroupingPeriod',
        'limit' => 'int',
    ...
    */
     ...
     *
     * @return \FlowHunt\Model\TransactionType|null
     */
     ...
     *
     * @param \FlowHunt\Model\TransactionType|null $transaction_type transaction_type
     *
     * @return self
     */
     ...
     * Gets grouping
     *
     * @return \FlowHunt\Model\GroupingPeriod|null
     */
     ...
     * Sets grouping
     *
     * @param \FlowHunt\Model\GroupingPeriod|null $grouping grouping
     *
     * @return self
     */
    ...
    {
        if (is_null($grouping)) {
            array_push($this->openAPINullablesSetToNull, 'grouping');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('grouping', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
