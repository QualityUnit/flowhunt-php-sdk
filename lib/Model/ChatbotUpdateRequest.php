    ...
    */
    ...
    public function setMaxWindowHeight($max_window_height)
    {
        ...
        if (!is_null($max_window_height) && (mb_strlen($max_window_height) > 32)) {
            throw new \InvalidArgumentException('invalid length for $max_window_height when calling ChatbotUpdateRequest., must be smaller than or equal to 32.');
        }
    ...
    public function setPrimaryColor($primary_color)
    {
        ...
        if (!is_null($primary_color) && (mb_strlen($primary_color) > 7)) {
            throw new \InvalidArgumentException('invalid length for $primary_color when calling ChatbotUpdateRequest., must be smaller than or equal to 7.');
        }
    ...
    public function setTextColor($text_color)
    {
        ...
        if (!is_null($text_color) && (mb_strlen($text_color) > 7)) {
            throw new \InvalidArgumentException('invalid length for $text_color when calling ChatbotUpdateRequest., must be smaller than or equal to 7.');
        }
    ...
    public function setTextDirection($text_direction)
    {
        ...
        if (!is_null($text_direction) && (mb_strlen($text_direction) > 1)) {
            throw new \InvalidArgumentException('invalid length for $text_direction when calling ChatbotUpdateRequest., must be smaller than or equal to 1.');
        }
    ...
    public function setLanguage($language)
    {
        ...
        if (!is_null($language) && (mb_strlen($language) > 10)) {
            throw new \InvalidArgumentException('invalid length for $language when calling ChatbotUpdateRequest., must be smaller than or equal to 10.');
        }
