 ...
 */
class TermsFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TermsFilter';
    ...
    {
        $this->setIfExists('op', $data ?? [], 'terms');
    ...
    */
    ...
    public function setValues($values)
    {
        ...
        if ((count($values) < 1)) {
            throw new \InvalidArgumentException('invalid length for $values when calling TermsFilter., number of items must be greater than or equal to 1.');
        }
