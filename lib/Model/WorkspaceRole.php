...
/**
 * WorkspaceRole Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class WorkspaceRole implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WorkspaceRole';
    ...
    */
     ...
     * Sets workspace_name
     *
     * @param mixed $workspace_name Workspace Name
     *
     * @return self
     */
    public function setWorkspaceName($workspace_name)
    {
        if (is_null($workspace_name)) {
            array_push($this->openAPINullablesSetToNull, 'workspace_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('workspace_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets role
     *
     * @param mixed $role Role of the user in the workspace (A - Admin, M - Member, G - Guest)
     *
     * @return self
     */
