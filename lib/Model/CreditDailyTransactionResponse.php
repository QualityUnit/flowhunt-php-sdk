...
class CreditDailyTransactionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets created_at
     *
     * @param mixed $created_at Transactions from date
     *
     * @return self
     */
     ...
     * Sets cnt
     *
     * @param mixed $cnt Number of transactions
     *
     * @return self
     */
    ...
    {
        if (is_null($cnt)) {
            array_push($this->openAPINullablesSetToNull, 'cnt');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cnt', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
