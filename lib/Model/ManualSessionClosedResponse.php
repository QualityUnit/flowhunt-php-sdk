...
/**
 * ManualSessionClosedResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class ManualSessionClosedResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ManualSessionClosedResponse';
    ...
    */
     ...
     * Sets flow_id
     *
     * @param string $flow_id The flow that was fired
     *
     * @return self
     */
     ...
     * Sets session_id
     *
     * @param string $session_id The session that was closed
     *
     * @return self
     */
     ...
     *
     * @param \FlowHunt\Model\FlowSessionStatus $response_status Status of the close-session invocation
     *
     * @return self
     */
