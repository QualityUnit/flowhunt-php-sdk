...
class ImageInferenceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'start_image' => 'setStartImage',
        'last_frame' => 'setLastFrame'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('guidance_scale', $data ?? [], null);
        ...
        $this->setIfExists('generate_audio', $data ?? [], null);
        $this->setIfExists('start_image', $data ?? [], null);
        $this->setIfExists('last_frame', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets guidance_scale
     *
     * @param float|null $guidance_scale guidance_scale
     *
     * @return self
     */
    public function setGuidanceScale($guidance_scale)
    {
        if (is_null($guidance_scale)) {
            array_push($this->openAPINullablesSetToNull, 'guidance_scale');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('guidance_scale', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        if (!is_null($guidance_scale) && ($guidance_scale > 10.0)) {
        ...
        if (!is_null($guidance_scale) && ($guidance_scale < 0.0)) {
     ...
     * Sets generate_audio
     *
     * @param bool|null $generate_audio generate_audio
     *
     * @return self
     */
    public function setGenerateAudio($generate_audio)
    {
        if (is_null($generate_audio)) {
            array_push($this->openAPINullablesSetToNull, 'generate_audio');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('generate_audio', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        return $this->container['start_image'];
    }

    /**
     * Sets start_image
     *
     * @param string[]|null $start_image start_image
     *
     * @return self
     */
    public function setStartImage($start_image)
    {
        if (is_null($start_image)) {
            array_push($this->openAPINullablesSetToNull, 'start_image');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('start_image', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['start_image'] = $start_image;
    ...
    {
        return $this->container['last_frame'];
    }

    /**
     * Sets last_frame
     *
     * @param string[]|null $last_frame last_frame
     *
     * @return self
     */
    public function setLastFrame($last_frame)
    {
        if (is_null($last_frame)) {
            array_push($this->openAPINullablesSetToNull, 'last_frame');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('last_frame', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['last_frame'] = $last_frame;
