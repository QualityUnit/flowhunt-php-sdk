    ...
    */
    ...
    public function setUpdatedAtFrom($updated_at_from)
    {
        if (is_null($updated_at_from)) {
            array_push($this->openAPINullablesSetToNull, 'updated_at_from');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('updated_at_from', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setUpdatedAtTo($updated_at_to)
    {
        if (is_null($updated_at_to)) {
            array_push($this->openAPINullablesSetToNull, 'updated_at_to');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('updated_at_to', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
