...
/**
 * MemoryNodePathSearchRequest Class Doc Comment
 *
 * @category Class
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 ...
 */
class MemoryNodePathSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MemoryNodePathSearchRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('node_path', $data ?? [], null);
    ...
    */
     ...
     * Sets node_path
     *
     * @param string|null $node_path node_path
     *
     * @return self
     */
    public function setNodePath($node_path)
    {
        if (is_null($node_path)) {
            array_push($this->openAPINullablesSetToNull, 'node_path');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('node_path', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
