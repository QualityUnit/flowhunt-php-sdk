...
class UserResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets product_plans
     *
     * @return array<string,\FlowHunt\Model\SubscriptionPlan>|null
     */
    public function getProductPlans()
    {
        return $this->container['product_plans'];
    }

    /**
     * Sets product_plans
     *
     * @param array<string,\FlowHunt\Model\SubscriptionPlan>|null $product_plans product_plans
     *
     * @return self
     */
    public function setProductPlans($product_plans)
    {
        if (is_null($product_plans)) {
            array_push($this->openAPINullablesSetToNull, 'product_plans');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('product_plans', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        return $this->container['sudoer'];
    }

    /**
     * Sets sudoer
     *
     * @param bool|null $sudoer Whether the user has superuser privileges
     *
     * @return self
     */
