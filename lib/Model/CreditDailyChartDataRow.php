...
/**
 * CreditDailyChartDataRow Class Doc Comment
 *
 * @category Class
 * @description A single row in the chart data representing one day&#39;s transactions.
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreditDailyChartDataRow implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreditDailyChartDataRow';
    ...
    */
     ...
     *
     * @param array<string,int> $transaction_types Dictionary of transaction type codes to their total amounts
     *
     * @return self
     */
