...
/**
 * ProjectIssueCommentArtefactResponse Class Doc Comment
 *
 * @category Class
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 ...
 */
class ProjectIssueCommentArtefactResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectIssueCommentArtefactResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('relative_path', $data ?? [], '');
        $this->setIfExists('s3_key', $data ?? [], '');
        $this->setIfExists('mime_type', $data ?? [], '');
        $this->setIfExists('size', $data ?? [], 0);
        $this->setIfExists('modified_at', $data ?? [], '');
        $this->setIfExists('download_url', $data ?? [], '');
    }
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Artefact ID
     *
     * @return self
     */
     ...
     * Sets relative_path
     *
     * @param string|null $relative_path Relative path in workspace
     *
     * @return self
     */
    public function setRelativePath($relative_path)
    {
        if (is_null($relative_path)) {
            throw new \InvalidArgumentException('non-nullable relative_path cannot be null');
        }
     ...
     * Sets s3_key
     *
     * @param string|null $s3_key S3 object key
     *
     * @return self
     */
     ...
     * Sets modified_at
     *
     * @param string|null $modified_at Last modified timestamp
     *
     * @return self
     */
     ...
     * Sets download_url
     *
     * @param string|null $download_url Direct download URL
     *
     * @return self
     */
