...
/**
 * AsanaWorkspaceResponse Class Doc Comment
 *
 * @category Class
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 ...
 */
class AsanaWorkspaceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AsanaWorkspaceResponse';
    ...
    {
        $this->setIfExists('workspace_gid', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['workspace_gid'] === null) {
            $invalidProperties[] = "'workspace_gid' can't be null";
        }
    ...
    {
        return $this->container['workspace_gid'];
    }

    /**
     * Sets workspace_gid
     *
     * @param string $workspace_gid workspace_gid
     *
     * @return self
     */
    public function setWorkspaceGid($workspace_gid)
    {
        if (is_null($workspace_gid)) {
            throw new \InvalidArgumentException('non-nullable workspace_gid cannot be null');
        }
        $this->container['workspace_gid'] = $workspace_gid;
