...
/**
 * ImageOptimizeRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ImageOptimizeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImageOptimizeRequest';
    ...
    */
    ...
    public function setQuality($quality)
    {
        ...
        if (!is_null($quality) && ($quality > 100)) {
            throw new \InvalidArgumentException('invalid value for $quality when calling ImageOptimizeRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($quality) && ($quality < 10)) {
            throw new \InvalidArgumentException('invalid value for $quality when calling ImageOptimizeRequest., must be bigger than or equal to 10.');
        }
