...
class ChatbotCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'max_window_height' => 'string',
        'msg_rpm' => 'int',
        'msg_ip_rpm' => 'int',
        'ratelimit_msg' => 'string',
    ...
    protected static $setters = [
        ...
        'max_window_height' => 'setMaxWindowHeight',
        'msg_rpm' => 'setMsgRpm',
        'msg_ip_rpm' => 'setMsgIpRpm',
        'ratelimit_msg' => 'setRatelimitMsg',
        ...
        'max_input_characters' => 'setMaxInputCharacters'
    ];
    ...
    protected static $getters = [
        ...
        'max_window_height' => 'getMaxWindowHeight',
        'msg_rpm' => 'getMsgRpm',
        'msg_ip_rpm' => 'getMsgIpRpm',
        'ratelimit_msg' => 'getRatelimitMsg',
        ...
        'max_input_characters' => 'getMaxInputCharacters'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('max_window_height', $data ?? [], null);
        $this->setIfExists('msg_rpm', $data ?? [], null);
        $this->setIfExists('msg_ip_rpm', $data ?? [], null);
        $this->setIfExists('ratelimit_msg', $data ?? [], null);
        ...
        $this->setIfExists('max_input_characters', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['max_window_height']) && (mb_strlen($this->container['max_window_height']) > 32)) {
            $invalidProperties[] = "invalid value for 'max_window_height', the character length must be smaller than or equal to 32.";
        }
        ...
        if (!is_null($this->container['primary_color']) && (mb_strlen($this->container['primary_color']) > 7)) {
            $invalidProperties[] = "invalid value for 'primary_color', the character length must be smaller than or equal to 7.";
        }

        if (!is_null($this->container['text_color']) && (mb_strlen($this->container['text_color']) > 7)) {
            $invalidProperties[] = "invalid value for 'text_color', the character length must be smaller than or equal to 7.";
        }
        ...
        if (!is_null($this->container['text_direction']) && (mb_strlen($this->container['text_direction']) > 1)) {
            $invalidProperties[] = "invalid value for 'text_direction', the character length must be smaller than or equal to 1.";
        }
     ...
     * Sets flow_id
     *
     * @param string|null $flow_id Chatbot Agent ID
     *
     * @return self
     */
    ...
    /**
     * Gets max_window_height
     *
     * @return string|null
     */
    public function getMaxWindowHeight()
    {
        return $this->container['max_window_height'];
    }

    /**
     * Sets max_window_height
     *
     * @param string|null $max_window_height max_window_height
     *
     * @return self
     */
    public function setMaxWindowHeight($max_window_height)
    {
        if (is_null($max_window_height)) {
            array_push($this->openAPINullablesSetToNull, 'max_window_height');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('max_window_height', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($max_window_height) && (mb_strlen($max_window_height) > 32)) {
            throw new \InvalidArgumentException('invalid length for $max_window_height when calling ChatbotCreateRequest., must be smaller than or equal to 32.');
        }

        $this->container['max_window_height'] = $max_window_height;
     ...
     * @return string|null
     */
    public function getRatelimitMsg()
    {
        return $this->container['ratelimit_msg'];
    }

    /**
     * Sets ratelimit_msg
     *
     * @param string|null $ratelimit_msg ratelimit_msg
     *
     * @return self
     */
    public function setRatelimitMsg($ratelimit_msg)
    {
        if (is_null($ratelimit_msg)) {
            array_push($this->openAPINullablesSetToNull, 'ratelimit_msg');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ratelimit_msg', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['ratelimit_msg'] = $ratelimit_msg;
    ...
    public function setChatBubbleBgColor($chat_bubble_bg_color)
    {
        ...
        if (!is_null($chat_bubble_bg_color) && (mb_strlen($chat_bubble_bg_color) > 7)) {
            throw new \InvalidArgumentException('invalid length for $chat_bubble_bg_color when calling ChatbotCreateRequest., must be smaller than or equal to 7.');
        }
    ...
    public function setChatBubbleIconColor($chat_bubble_icon_color)
    {
        ...
        if (!is_null($chat_bubble_icon_color) && (mb_strlen($chat_bubble_icon_color) > 7)) {
            throw new \InvalidArgumentException('invalid length for $chat_bubble_icon_color when calling ChatbotCreateRequest., must be smaller than or equal to 7.');
        }
    ...
    public function setPrimaryColor($primary_color)
    {
        ...
        if (!is_null($primary_color) && (mb_strlen($primary_color) > 7)) {
            throw new \InvalidArgumentException('invalid length for $primary_color when calling ChatbotCreateRequest., must be smaller than or equal to 7.');
        }
    ...
    public function setTextColor($text_color)
    {
        ...
        if (!is_null($text_color) && (mb_strlen($text_color) > 7)) {
            throw new \InvalidArgumentException('invalid length for $text_color when calling ChatbotCreateRequest., must be smaller than or equal to 7.');
        }
    ...
    public function setChatbotTheme($chatbot_theme)
    {
        ...
        if (!is_null($chatbot_theme) && (mb_strlen($chatbot_theme) > 1)) {
            throw new \InvalidArgumentException('invalid length for $chatbot_theme when calling ChatbotCreateRequest., must be smaller than or equal to 1.');
        }
    ...
    public function setChatbotPosition($chatbot_position)
    {
        ...
        if (!is_null($chatbot_position) && (mb_strlen($chatbot_position) > 2)) {
            throw new \InvalidArgumentException('invalid length for $chatbot_position when calling ChatbotCreateRequest., must be smaller than or equal to 2.');
        }
    ...
    public function setTextDirection($text_direction)
    {
        if (is_null($text_direction)) {
            array_push($this->openAPINullablesSetToNull, 'text_direction');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('text_direction', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($text_direction) && (mb_strlen($text_direction) > 1)) {
            throw new \InvalidArgumentException('invalid length for $text_direction when calling ChatbotCreateRequest., must be smaller than or equal to 1.');
        }
    ...
    public function setMessagePlaceholder($message_placeholder)
    {
        ...
        if (!is_null($message_placeholder) && (mb_strlen($message_placeholder) > 255)) {
            throw new \InvalidArgumentException('invalid length for $message_placeholder when calling ChatbotCreateRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setChatbotHeaderText($chatbot_header_text)
    {
        ...
        if (!is_null($chatbot_header_text) && (mb_strlen($chatbot_header_text) > 255)) {
            throw new \InvalidArgumentException('invalid length for $chatbot_header_text when calling ChatbotCreateRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setChatbotStyle($chatbot_style)
    {
        ...
        if (!is_null($chatbot_style) && (mb_strlen($chatbot_style) > 30)) {
            throw new \InvalidArgumentException('invalid length for $chatbot_style when calling ChatbotCreateRequest., must be smaller than or equal to 30.');
        }
    ...
    public function setLanguage($language)
    {
        ...
        if (!is_null($language) && (mb_strlen($language) > 10)) {
            throw new \InvalidArgumentException('invalid length for $language when calling ChatbotCreateRequest., must be smaller than or equal to 10.');
        }
    ...
    /**
     * Gets max_input_characters
     *
     * @return int|null
     */
    public function getMaxInputCharacters()
    {
        return $this->container['max_input_characters'];
    }

    /**
     * Sets max_input_characters
     *
     * @param int|null $max_input_characters max_input_characters
     *
     * @return self
     */
    public function setMaxInputCharacters($max_input_characters)
    {
        if (is_null($max_input_characters)) {
            array_push($this->openAPINullablesSetToNull, 'max_input_characters');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('max_input_characters', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['max_input_characters'] = $max_input_characters;
