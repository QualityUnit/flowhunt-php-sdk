...
/**
 * FlowCronUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 ...
 */
class FlowCronUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlowCronUpdateRequest';
    ...
    */
     ...
     *
     * @param string|null $interval_settings interval_settings
     *
     * @return self
     */
    public function setIntervalSettings($interval_settings)
    {
        if (is_null($interval_settings)) {
            array_push($this->openAPINullablesSetToNull, 'interval_settings');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('interval_settings', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
