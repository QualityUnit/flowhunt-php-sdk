...
/**
 * FlowValidationError Class Doc Comment
 *
 * @category Class
 * @description Single flow validation error with node context.
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FlowValidationError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlowValidationError';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('error_level', $data ?? [], 'error');
    ...
    */
     ...
     * Sets node_id
     *
     * @param string $node_id ID of the node with the error
     *
     * @return self
     */
     ...
     * Sets param_name
     *
     * @param string $param_name The parameter that failed validation
     *
     * @return self
     */
     ...
     * Sets error_level
     *
     * @param string|null $error_level Severity level of the validation issue
     *
     * @return self
     */
