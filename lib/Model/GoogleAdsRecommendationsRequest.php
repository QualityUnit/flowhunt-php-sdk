...
/**
 * GoogleAdsRecommendationsRequest Class Doc Comment
 *
 * @category Class
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 ...
 */
class GoogleAdsRecommendationsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GoogleAdsRecommendationsRequest';
    ...
    */
     ...
     * Sets customer_id
     *
     * @param string $customer_id Customer id to get recommendations for
     *
     * @return self
     */
