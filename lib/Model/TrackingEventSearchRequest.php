...
/**
 * TrackingEventSearchRequest Class Doc Comment
 *
 * @category Class
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 ...
 */
class TrackingEventSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrackingEventSearchRequest';
    ...
    */
    ...
    public function setPage($page)
    {
        ...
        if (!is_null($page) && ($page < 1)) {
            throw new \InvalidArgumentException('invalid value for $page when calling TrackingEventSearchRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 100)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling TrackingEventSearchRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($page_size) && ($page_size < 1)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling TrackingEventSearchRequest., must be bigger than or equal to 1.');
        }
