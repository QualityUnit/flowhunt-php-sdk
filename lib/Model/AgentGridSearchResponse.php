...
/**
 * AgentGridSearchResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class AgentGridSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AgentGridSearchResponse';
    ...
    */
     ...
     * Sets rows
     *
     * @param array<string,mixed>[] $rows Search result rows
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int $total_count Total number of matching rows
     *
     * @return self
     */
