...
/**
 * ProjectInboxSearchRequest Class Doc Comment
 *
 * @category Class
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 ...
 */
class ProjectInboxSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectInboxSearchRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('unread_only', $data ?? [], false);
    ...
    */
     ...
     * Sets unread_only
     *
     * @param bool|null $unread_only Convenience flag — overrides status when true to return only unread entries.
     *
     * @return self
     */
    ...
    public function setLimit($limit)
    {
        ...
        if (!is_null($limit) && ($limit > 200)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling ProjectInboxSearchRequest., must be smaller than or equal to 200.');
        }
        if (!is_null($limit) && ($limit < 1)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling ProjectInboxSearchRequest., must be bigger than or equal to 1.');
        }
