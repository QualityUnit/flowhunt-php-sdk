...
/**
 * FlowInvokeRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class FlowInvokeRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlowInvokeRequest';
    ...
    protected static $openAPITypes = [
        ...
        'human_input' => 'mixed',
        'variables' => '\OpenAPI\Client\Model\Variables'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['human_input'] === null) {
            $invalidProperties[] = "'human_input' can't be null";
        }
     ...
     * @return mixed
     */
    public function getHumanInput()
    {
        return $this->container['human_input'];
    }

    /**
     * Sets human_input
     *
     * @param mixed $human_input The human input
     *
     * @return self
     */
    public function setHumanInput($human_input)
    {
        if (is_null($human_input)) {
            array_push($this->openAPINullablesSetToNull, 'human_input');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('human_input', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['human_input'] = $human_input;
     ...
     * Gets variables
     *
     * @return \OpenAPI\Client\Model\Variables|null
     */
     ...
     * Sets variables
     *
     * @param \OpenAPI\Client\Model\Variables|null $variables variables
     *
     * @return self
     */
