...
class UrlScreenshotResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets original_image
     *
     * @param string $original_image original_image
     *
     * @return self
     */
    public function setOriginalImage($original_image)
    {
        if (is_null($original_image)) {
            throw new \InvalidArgumentException('non-nullable original_image cannot be null');
        }
     ...
     *
     * @param string $thumbnail_image thumbnail_image
     *
     * @return self
     */
