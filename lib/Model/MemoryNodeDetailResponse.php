...
/**
 * MemoryNodeDetailResponse Class Doc Comment
 *
 * @category Class
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 ...
 */
class MemoryNodeDetailResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MemoryNodeDetailResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('offload_ids', $data ?? [], null);
    ...
    */
     ...
     * @return string[]|null
     */
    public function getOffloadIds()
    {
        return $this->container['offload_ids'];
    }

    /**
     * Sets offload_ids
     *
     * @param string[]|null $offload_ids offload_ids
     *
     * @return self
     */
    public function setOffloadIds($offload_ids)
    {
        if (is_null($offload_ids)) {
            array_push($this->openAPINullablesSetToNull, 'offload_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('offload_ids', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['offload_ids'] = $offload_ids;
     ...
     * Gets sources
     *
     * @return \FlowHunt\Model\Source[]|null
     */
     ...
     * Sets sources
     *
     * @param \FlowHunt\Model\Source[]|null $sources sources
     *
     * @return self
     */
