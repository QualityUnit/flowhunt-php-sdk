...
class FlowUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'category_id' => 'string',
        'engine_version' => '\FlowHunt\Model\FlowEngineVersion',
        'try_flow_input_placeholder' => 'string',
        'disable_text_input' => 'bool',
        'branch' => '\FlowHunt\Model\FlowBranch',
        'enable_cache' => 'bool',
        'version_nr' => 'int'
    ];
    ...
    */
     ...
     * Sets config
     *
     * @param \FlowHunt\Model\FlowConfig $config The agent configuration
     *
     * @return self
     */
     ...
     * Gets engine_version
     *
     * @return \FlowHunt\Model\FlowEngineVersion|null
     */
     ...
     * Sets engine_version
     *
     * @param \FlowHunt\Model\FlowEngineVersion|null $engine_version engine_version
     *
     * @return self
     */
     ...
     * Gets branch
     *
     * @return \FlowHunt\Model\FlowBranch|null
     */
     ...
     * Sets branch
     *
     * @param \FlowHunt\Model\FlowBranch|null $branch The agent branch
     *
     * @return self
     */
     ...
     * Sets enable_cache
     *
     * @param bool|null $enable_cache enable_cache
     *
     * @return self
     */
    public function setEnableCache($enable_cache)
    {
        if (is_null($enable_cache)) {
            array_push($this->openAPINullablesSetToNull, 'enable_cache');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('enable_cache', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
