...
class DocumentContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'credits' => 'int',
        'url_content' => 'array<string,mixed>',
        'merchant_metadata' => '\FlowHunt\Model\MerchantMetadata'
    ];
    ...
    protected static $setters = [
        ...
        'doc_type' => 'setDocType',
        'credits' => 'setCredits',
        'url_content' => 'setUrlContent',
        'merchant_metadata' => 'setMerchantMetadata'
    ];
    ...
    protected static $getters = [
        ...
        'doc_type' => 'getDocType',
        'credits' => 'getCredits',
        'url_content' => 'getUrlContent',
        'merchant_metadata' => 'getMerchantMetadata'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('url_content', $data ?? [], null);
        $this->setIfExists('merchant_metadata', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets page_numbers
     *
     * @param int[]|null $page_numbers page_numbers
     *
     * @return self
     */
    public function setPageNumbers($page_numbers)
    {
        if (is_null($page_numbers)) {
            array_push($this->openAPINullablesSetToNull, 'page_numbers');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('page_numbers', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    {
        return $this->container['url_content'];
    }

    /**
     * Sets url_content
     *
     * @param array<string,mixed>|null $url_content url_content
     *
     * @return self
     */
    public function setUrlContent($url_content)
    {
        if (is_null($url_content)) {
            array_push($this->openAPINullablesSetToNull, 'url_content');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('url_content', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['url_content'] = $url_content;

        return $this;
    }

    /**
     * Gets merchant_metadata
     *
     * @return \FlowHunt\Model\MerchantMetadata|null
     */
    public function getMerchantMetadata()
    {
        return $this->container['merchant_metadata'];
    }

    /**
     * Sets merchant_metadata
     *
     * @param \FlowHunt\Model\MerchantMetadata|null $merchant_metadata merchant_metadata
     *
     * @return self
     */
    public function setMerchantMetadata($merchant_metadata)
    {
        if (is_null($merchant_metadata)) {
            array_push($this->openAPINullablesSetToNull, 'merchant_metadata');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('merchant_metadata', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['merchant_metadata'] = $merchant_metadata;
