...
class FlowResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets description
     *
     * @param mixed $description Flow description
     *
     * @return self
     */
     ...
     * Sets flow_type
     *
     * @param \OpenAPI\Client\Model\FlowType $flow_type flow_type
     *
     * @return self
     */
     ...
     *
     * @param mixed $component_count Component count
     *
     * @return self
     */
    public function setComponentCount($component_count)
    {
        if (is_null($component_count)) {
            array_push($this->openAPINullablesSetToNull, 'component_count');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('component_count', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
