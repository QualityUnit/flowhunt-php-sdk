...
/**
 * SuggestionResponse Class Doc Comment
 *
 * @category Class
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 ...
 */
class SuggestionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SuggestionResponse';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Suggestion index
     *
     * @return self
     */
     ...
     * Sets question
     *
     * @param string $question Suggested question text
     *
     * @return self
     */
