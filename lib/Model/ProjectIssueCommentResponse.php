...
/**
 * ProjectIssueCommentResponse Class Doc Comment
 *
 * @category Class
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 ...
 */
class ProjectIssueCommentResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProjectIssueCommentResponse';
    ...
    protected static $openAPITypes = [
        ...
        'text' => 'string',
        'created_at' => 'string',
        'artefacts' => '\FlowHunt\Model\ProjectIssueCommentArtefactResponse[]',
        'comment_type' => 'string',
    ...
    */
     ...
     * Gets artefacts
     *
     * @return \FlowHunt\Model\ProjectIssueCommentArtefactResponse[]|null
     */
     ...
     * Sets artefacts
     *
     * @param \FlowHunt\Model\ProjectIssueCommentArtefactResponse[]|null $artefacts Artefacts attached to this comment
     *
     * @return self
     */
    ...
    public function setCommentType($comment_type)
    {
        if (is_null($comment_type)) {
            array_push($this->openAPINullablesSetToNull, 'comment_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('comment_type', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets metadata
     *
     * @param array<string,mixed>|null $metadata Structured metadata for specialized comment types.
     *
     * @return self
     */
