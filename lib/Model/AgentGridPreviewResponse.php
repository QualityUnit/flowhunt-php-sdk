...
/**
 * AgentGridPreviewResponse Class Doc Comment
 *
 * @category Class
 * @description Schema for agent grid preview response (first N rows).
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AgentGridPreviewResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AgentGridPreviewResponse';
    ...
    */
     ...
     * Sets rows
     *
     * @param array<string,mixed>[] $rows Preview rows
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int $total_count Total number of rows in the table
     *
     * @return self
     */
