...
/**
 * GridColumnUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GridColumnUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GridColumnUpdateRequest';
    ...
    */
     ...
     * Gets data_type
     *
     * @return \OpenAPI\Client\Model\ColumnDataType|null
     */
     ...
     * Sets data_type
     *
     * @param \OpenAPI\Client\Model\ColumnDataType|null $data_type data_type
     *
     * @return self
     */
     ...
     * Gets executor_type
     *
     * @return \OpenAPI\Client\Model\ColumnExecutorType|null
     */
     ...
     * Sets executor_type
     *
     * @param \OpenAPI\Client\Model\ColumnExecutorType|null $executor_type executor_type
     *
     * @return self
     */
    public function setExecutorType($executor_type)
    {
        if (is_null($executor_type)) {
            array_push($this->openAPINullablesSetToNull, 'executor_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('executor_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
