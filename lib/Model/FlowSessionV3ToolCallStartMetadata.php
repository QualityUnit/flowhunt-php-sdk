...
/**
 * FlowSessionV3ToolCallStartMetadata Class Doc Comment
 *
 * @category Class
 ...
 */
class FlowSessionV3ToolCallStartMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlowSessionV3ToolCallStartMetadata';
    ...
    */
    ...
    public function setActionDescription($action_description)
    {
        if (is_null($action_description)) {
            array_push($this->openAPINullablesSetToNull, 'action_description');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('action_description', $nullablesSetToNull);
            if ($index !== FALSE) {
