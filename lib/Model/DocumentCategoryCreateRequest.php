...
/**
 * DocumentCategoryCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DocumentCategoryCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DocumentCategoryCreateRequest';
    ...
    */
     ...
     * Sets cat_color
     *
     * @param mixed $cat_color Category color
     *
     * @return self
     */
    public function setCatColor($cat_color)
    {
        if (is_null($cat_color)) {
            array_push($this->openAPINullablesSetToNull, 'cat_color');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cat_color', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
