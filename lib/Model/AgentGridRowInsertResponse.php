...
/**
 * AgentGridRowInsertResponse Class Doc Comment
 *
 * @category Class
 * @description Schema for row insert response.
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AgentGridRowInsertResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AgentGridRowInsertResponse';
    ...
    */
     ...
     * Sets row_id
     *
     * @param string $row_id ID of the inserted row
     *
     * @return self
     */
