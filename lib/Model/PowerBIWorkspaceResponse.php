...
/**
 * PowerBIWorkspaceResponse Class Doc Comment
 *
 * @category Class
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 ...
 */
class PowerBIWorkspaceResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PowerBIWorkspaceResponse';
    ...
    */
     ...
     * Sets workspace_id
     *
     * @param string $workspace_id Power BI workspace ID
     *
     * @return self
     */
     ...
     * Sets workspace_name
     *
     * @param string $workspace_name Power BI workspace name
     *
     * @return self
     */
