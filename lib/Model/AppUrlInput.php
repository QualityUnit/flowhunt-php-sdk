 ...
 */
class AppUrlInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AppUrl-Input';
    ...
    */
    ...
    public function setParsedUrl($parsed_url)
    {
        ...
        if ((count($parsed_url) > 6)) {
            throw new \InvalidArgumentException('invalid value for $parsed_url when calling AppUrlInput., number of items must be less than or equal to 6.');
        }
        if ((count($parsed_url) < 6)) {
            throw new \InvalidArgumentException('invalid length for $parsed_url when calling AppUrlInput., number of items must be greater than or equal to 6.');
        }
