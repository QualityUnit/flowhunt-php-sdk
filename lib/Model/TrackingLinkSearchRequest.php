...
/**
 * TrackingLinkSearchRequest Class Doc Comment
 *
 * @category Class
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 ...
 */
class TrackingLinkSearchRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TrackingLinkSearchRequest';
    ...
    protected static $attributeMap = [
        'src_link_id' => 'src_link_id',
        'dst_link_id' => 'dst_link_id',
        'from_date' => 'from_date',
        'to_date' => 'to_date',
    ...
    protected static $setters = [
        'src_link_id' => 'setSrcLinkId',
        'dst_link_id' => 'setDstLinkId',
    ...
    protected static $getters = [
        'src_link_id' => 'getSrcLinkId',
        'dst_link_id' => 'getDstLinkId',
    ...
    {
        $this->setIfExists('src_link_id', $data ?? [], null);
        $this->setIfExists('dst_link_id', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getSrcLinkId()
    {
        return $this->container['src_link_id'];
    }

    /**
     * Sets src_link_id
     *
     * @param string|null $src_link_id src_link_id
     *
     * @return self
     */
    public function setSrcLinkId($src_link_id)
    {
        if (is_null($src_link_id)) {
            array_push($this->openAPINullablesSetToNull, 'src_link_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('src_link_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['src_link_id'] = $src_link_id;
     ...
     * @return string|null
     */
    public function getDstLinkId()
    {
        return $this->container['dst_link_id'];
    }

    /**
     * Sets dst_link_id
     *
     * @param string|null $dst_link_id dst_link_id
     *
     * @return self
     */
    public function setDstLinkId($dst_link_id)
    {
        if (is_null($dst_link_id)) {
            array_push($this->openAPINullablesSetToNull, 'dst_link_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dst_link_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['dst_link_id'] = $dst_link_id;
    ...
    public function setPage($page)
    {
        ...
        if (!is_null($page) && ($page < 1)) {
            throw new \InvalidArgumentException('invalid value for $page when calling TrackingLinkSearchRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPageSize($page_size)
    {
        ...
        if (!is_null($page_size) && ($page_size > 100)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling TrackingLinkSearchRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($page_size) && ($page_size < 1)) {
            throw new \InvalidArgumentException('invalid value for $page_size when calling TrackingLinkSearchRequest., must be bigger than or equal to 1.');
        }
