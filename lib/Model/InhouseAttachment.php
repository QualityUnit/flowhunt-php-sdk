...
/**
 * InhouseAttachment Class Doc Comment
 *
 * @category Class
 * @description Attachment whose bytes live in our S3 delivery bucket.
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InhouseAttachment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InhouseAttachment';
    ...
    public const SOURCE_INHOUSE = 'inhouse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('source', $data ?? [], 'inhouse');
    }
    ...
    */
     ...
     * Sets file_id
     *
     * @param string $file_id Session-local identifier
     *
     * @return self
     */
