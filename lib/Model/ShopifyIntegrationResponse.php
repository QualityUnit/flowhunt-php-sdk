...
/**
 * ShopifyIntegrationResponse Class Doc Comment
 *
 * @category Class
 * @package  FlowHunt
 * @author   OpenAPI Generator team
 ...
 */
class ShopifyIntegrationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ShopifyIntegrationResponse';
    ...
    */
    ...
    {
        if (is_null($shop_url)) {
            array_push($this->openAPINullablesSetToNull, 'shop_url');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('shop_url', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param string|null $shopify_client_id shopify_client_id
     *
     * @return self
     */
    public function setShopifyClientId($shopify_client_id)
    {
        if (is_null($shopify_client_id)) {
            array_push($this->openAPINullablesSetToNull, 'shopify_client_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('shopify_client_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
