...
class FlowSessionsApi
{
    ...
    /**
     * Operation searchFlowEvent
     *
     * Search Flow Event
     *
     * @param  string $workspace_id workspace_id (required)
     * @param  \FlowHunt\Model\FlowEventsSearchRequest $flow_events_search_request flow_events_search_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchFlowEvent'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FlowHunt\Model\FlowEventsSearchResponse[]|\FlowHunt\Model\HTTPValidationError
     */
    public function searchFlowEvent($workspace_id, $flow_events_search_request, string $contentType = self::contentTypes['searchFlowEvent'][0])
    {
        list($response) = $this->searchFlowEventWithHttpInfo($workspace_id, $flow_events_search_request, $contentType);
        return $response;
    }

    /**
     * Operation searchFlowEventWithHttpInfo
     *
     * Search Flow Event
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\FlowEventsSearchRequest $flow_events_search_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchFlowEvent'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FlowHunt\Model\FlowEventsSearchResponse[]|\FlowHunt\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchFlowEventWithHttpInfo($workspace_id, $flow_events_search_request, string $contentType = self::contentTypes['searchFlowEvent'][0])
    {
        $request = $this->searchFlowEventRequest($workspace_id, $flow_events_search_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\FlowHunt\Model\FlowEventsSearchResponse[]',
                        $request,
                        $response,
                    );
                case 422:
    ...
    /**
     * Operation searchFlowEventAsync
     *
     * Search Flow Event
     *
     * @param  string $workspace_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchFlowEventAsync($workspace_id, $flow_events_search_request, string $contentType = self::contentTypes['searchFlowEvent'][0])
    {
        return $this->searchFlowEventAsyncWithHttpInfo($workspace_id, $flow_events_search_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation searchFlowEventAsyncWithHttpInfo
     *
     * Search Flow Event
     *
     * @param  string $workspace_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchFlowEventAsyncWithHttpInfo($workspace_id, $flow_events_search_request, string $contentType = self::contentTypes['searchFlowEvent'][0])
    {
        $returnType = '\FlowHunt\Model\FlowEventsSearchResponse[]';
        $request = $this->searchFlowEventRequest($workspace_id, $flow_events_search_request, $contentType);
    ...
    /**
     * Create request for operation 'searchFlowEvent'
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\FlowEventsSearchRequest $flow_events_search_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchFlowEvent'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchFlowEventRequest($workspace_id, $flow_events_search_request, string $contentType = self::contentTypes['searchFlowEvent'][0])
    {

        // verify the required parameter 'workspace_id' is set
        if ($workspace_id === null || (is_array($workspace_id) && count($workspace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $workspace_id when calling searchFlowEvent'
            );
        }

        // verify the required parameter 'flow_events_search_request' is set
        if ($flow_events_search_request === null || (is_array($flow_events_search_request) && count($flow_events_search_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $flow_events_search_request when calling searchFlowEvent'
            );
        }


        $resourcePath = '/v2/chatbots/sessions/search_event';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($flow_events_search_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($flow_events_search_request));
            } else {
                $httpBody = $flow_events_search_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
