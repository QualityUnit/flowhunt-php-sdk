...
class ChatbotsApi
{
    ...
    /**
     * Operation bulkDeleteChatbots
     *
     * Bulk Delete Chatbots
     *
     * @param  string $workspace_id workspace_id (required)
     * @param  \FlowHunt\Model\ChatbotBulkDeleteRequest $chatbot_bulk_delete_request chatbot_bulk_delete_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bulkDeleteChatbots'] to see the possible values for this operation
     *
     ...
     */
    public function bulkDeleteChatbots($workspace_id, $chatbot_bulk_delete_request, string $contentType = self::contentTypes['bulkDeleteChatbots'][0])
    {
        list($response) = $this->bulkDeleteChatbotsWithHttpInfo($workspace_id, $chatbot_bulk_delete_request, $contentType);
        return $response;
    }

    /**
     * Operation bulkDeleteChatbotsWithHttpInfo
     *
     * Bulk Delete Chatbots
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\ChatbotBulkDeleteRequest $chatbot_bulk_delete_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bulkDeleteChatbots'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function bulkDeleteChatbotsWithHttpInfo($workspace_id, $chatbot_bulk_delete_request, string $contentType = self::contentTypes['bulkDeleteChatbots'][0])
    {
        $request = $this->bulkDeleteChatbotsRequest($workspace_id, $chatbot_bulk_delete_request, $contentType);
    ...
    /**
     * Operation bulkDeleteChatbotsAsync
     *
     * Bulk Delete Chatbots
     *
     * @param  string $workspace_id (required)
     ...
     */
    public function bulkDeleteChatbotsAsync($workspace_id, $chatbot_bulk_delete_request, string $contentType = self::contentTypes['bulkDeleteChatbots'][0])
    {
        return $this->bulkDeleteChatbotsAsyncWithHttpInfo($workspace_id, $chatbot_bulk_delete_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation bulkDeleteChatbotsAsyncWithHttpInfo
     *
     * Bulk Delete Chatbots
     *
     * @param  string $workspace_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bulkDeleteChatbotsAsyncWithHttpInfo($workspace_id, $chatbot_bulk_delete_request, string $contentType = self::contentTypes['bulkDeleteChatbots'][0])
    {
    ...
    /**
     * Create request for operation 'bulkDeleteChatbots'
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\ChatbotBulkDeleteRequest $chatbot_bulk_delete_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bulkDeleteChatbots'] to see the possible values for this operation
     ...
     */
    public function bulkDeleteChatbotsRequest($workspace_id, $chatbot_bulk_delete_request, string $contentType = self::contentTypes['bulkDeleteChatbots'][0])
    {

        // verify the required parameter 'workspace_id' is set
        if ($workspace_id === null || (is_array($workspace_id) && count($workspace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $workspace_id when calling bulkDeleteChatbots'
            );
        }

        // verify the required parameter 'chatbot_bulk_delete_request' is set
        if ($chatbot_bulk_delete_request === null || (is_array($chatbot_bulk_delete_request) && count($chatbot_bulk_delete_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $chatbot_bulk_delete_request when calling bulkDeleteChatbots'
            );
        }


        $resourcePath = '/v2/chatbots/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($chatbot_bulk_delete_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($chatbot_bulk_delete_request));
            } else {
                $httpBody = $chatbot_bulk_delete_request;
            }
    ...
    /**
     * Operation bulkUpdateChatbots
     *
     * Bulk Update Chatbots
     *
     * @param  string $workspace_id workspace_id (required)
     * @param  \FlowHunt\Model\ChatbotBulkUpdateRequest $chatbot_bulk_update_request chatbot_bulk_update_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bulkUpdateChatbots'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FlowHunt\Model\Completed|\FlowHunt\Model\HTTPValidationError
     */
    public function bulkUpdateChatbots($workspace_id, $chatbot_bulk_update_request, string $contentType = self::contentTypes['bulkUpdateChatbots'][0])
    {
        list($response) = $this->bulkUpdateChatbotsWithHttpInfo($workspace_id, $chatbot_bulk_update_request, $contentType);
        return $response;
    }

    /**
     * Operation bulkUpdateChatbotsWithHttpInfo
     *
     * Bulk Update Chatbots
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\ChatbotBulkUpdateRequest $chatbot_bulk_update_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bulkUpdateChatbots'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FlowHunt\Model\Completed|\FlowHunt\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function bulkUpdateChatbotsWithHttpInfo($workspace_id, $chatbot_bulk_update_request, string $contentType = self::contentTypes['bulkUpdateChatbots'][0])
    {
        $request = $this->bulkUpdateChatbotsRequest($workspace_id, $chatbot_bulk_update_request, $contentType);
    ...
    /**
     * Operation bulkUpdateChatbotsAsync
     *
     * Bulk Update Chatbots
     *
     * @param  string $workspace_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bulkUpdateChatbotsAsync($workspace_id, $chatbot_bulk_update_request, string $contentType = self::contentTypes['bulkUpdateChatbots'][0])
    {
        return $this->bulkUpdateChatbotsAsyncWithHttpInfo($workspace_id, $chatbot_bulk_update_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation bulkUpdateChatbotsAsyncWithHttpInfo
     *
     * Bulk Update Chatbots
     *
     * @param  string $workspace_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bulkUpdateChatbotsAsyncWithHttpInfo($workspace_id, $chatbot_bulk_update_request, string $contentType = self::contentTypes['bulkUpdateChatbots'][0])
    {
        $returnType = '\FlowHunt\Model\Completed';
        $request = $this->bulkUpdateChatbotsRequest($workspace_id, $chatbot_bulk_update_request, $contentType);
    ...
    /**
     * Create request for operation 'bulkUpdateChatbots'
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\ChatbotBulkUpdateRequest $chatbot_bulk_update_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bulkUpdateChatbots'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function bulkUpdateChatbotsRequest($workspace_id, $chatbot_bulk_update_request, string $contentType = self::contentTypes['bulkUpdateChatbots'][0])
    {

        // verify the required parameter 'workspace_id' is set
        if ($workspace_id === null || (is_array($workspace_id) && count($workspace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $workspace_id when calling bulkUpdateChatbots'
            );
        }

        // verify the required parameter 'chatbot_bulk_update_request' is set
        if ($chatbot_bulk_update_request === null || (is_array($chatbot_bulk_update_request) && count($chatbot_bulk_update_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $chatbot_bulk_update_request when calling bulkUpdateChatbots'
            );
        }


        $resourcePath = '/v2/chatbots/update';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($chatbot_bulk_update_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($chatbot_bulk_update_request));
            } else {
                $httpBody = $chatbot_bulk_update_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
