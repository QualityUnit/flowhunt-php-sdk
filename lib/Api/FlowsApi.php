...
class FlowsApi
{
    ...
    /**
     * Operation cancelFlowSession
     *
     * Cancel Flow Session
     *
     * @param  string $session_id session_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cancelFlowSession'] to see the possible values for this operation
     *
     ...
     */
    public function cancelFlowSession($session_id, string $contentType = self::contentTypes['cancelFlowSession'][0])
    {
        list($response) = $this->cancelFlowSessionWithHttpInfo($session_id, $contentType);
        return $response;
    }

    /**
     * Operation cancelFlowSessionWithHttpInfo
     *
     * Cancel Flow Session
     *
     ...
     */
    public function cancelFlowSessionWithHttpInfo($session_id, string $contentType = self::contentTypes['cancelFlowSession'][0])
    {
        $request = $this->cancelFlowSessionRequest($session_id, $contentType);
    ...
    /**
     * Operation cancelFlowSessionAsync
     *
     * Cancel Flow Session
     *
     * @param  string $session_id (required)
     ...
     */
    public function cancelFlowSessionAsync($session_id, string $contentType = self::contentTypes['cancelFlowSession'][0])
    {
        return $this->cancelFlowSessionAsyncWithHttpInfo($session_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation cancelFlowSessionAsyncWithHttpInfo
     *
     * Cancel Flow Session
     *
     * @param  string $session_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function cancelFlowSessionAsyncWithHttpInfo($session_id, string $contentType = self::contentTypes['cancelFlowSession'][0])
    {
    ...
    /**
     * Create request for operation 'cancelFlowSession'
     *
     * @param  string $session_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['cancelFlowSession'] to see the possible values for this operation
     *
     ...
     */
    public function cancelFlowSessionRequest($session_id, string $contentType = self::contentTypes['cancelFlowSession'][0])
    {

        // verify the required parameter 'session_id' is set
        if ($session_id === null || (is_array($session_id) && count($session_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $session_id when calling cancelFlowSession'
            );
        }


        $resourcePath = '/v2/flows/sessions/{session_id}/cancel';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function downloadAttachment($session_id, $file_id, string $contentType = self::contentTypes['downloadAttachment'][0])
    {
        list($response) = $this->downloadAttachmentWithHttpInfo($session_id, $file_id, $contentType);
        return $response;
    }
     ...
     */
    public function downloadAttachmentWithHttpInfo($session_id, $file_id, string $contentType = self::contentTypes['downloadAttachment'][0])
    {
        $request = $this->downloadAttachmentRequest($session_id, $file_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function downloadAttachmentAsync($session_id, $file_id, string $contentType = self::contentTypes['downloadAttachment'][0])
    {
        return $this->downloadAttachmentAsyncWithHttpInfo($session_id, $file_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function downloadAttachmentAsyncWithHttpInfo($session_id, $file_id, string $contentType = self::contentTypes['downloadAttachment'][0])
    {
        $returnType = 'mixed';
        $request = $this->downloadAttachmentRequest($session_id, $file_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function downloadAttachmentRequest($session_id, $file_id, string $contentType = self::contentTypes['downloadAttachment'][0])
    {

        // verify the required parameter 'session_id' is set
        if ($session_id === null || (is_array($session_id) && count($session_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $session_id when calling downloadAttachment'
            );
        }
        ...
        if ($file_id === null || (is_array($file_id) && count($file_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $file_id when calling downloadAttachment'
            );
        }
    ...
    /**
     * Operation getArtefactContent
     *
     * Get artefact content
     *
     * @param  string $session_id session_id (required)
     * @param  string $artefact_id artefact_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getArtefactContent'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FlowHunt\Model\FlowSessionArtefactContentResponse|\FlowHunt\Model\HTTPValidationError
     */
    public function getArtefactContent($session_id, $artefact_id, string $contentType = self::contentTypes['getArtefactContent'][0])
    {
        list($response) = $this->getArtefactContentWithHttpInfo($session_id, $artefact_id, $contentType);
        return $response;
    }

    /**
     * Operation getArtefactContentWithHttpInfo
     *
     * Get artefact content
     *
     * @param  string $session_id (required)
     * @param  string $artefact_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getArtefactContent'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FlowHunt\Model\FlowSessionArtefactContentResponse|\FlowHunt\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getArtefactContentWithHttpInfo($session_id, $artefact_id, string $contentType = self::contentTypes['getArtefactContent'][0])
    {
        $request = $this->getArtefactContentRequest($session_id, $artefact_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\FlowHunt\Model\FlowSessionArtefactContentResponse',
                        $request,
                        $response,
                    );
                case 422:
    ...
    /**
     * Operation getArtefactContentAsync
     *
     * Get artefact content
     *
     * @param  string $session_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getArtefactContentAsync($session_id, $artefact_id, string $contentType = self::contentTypes['getArtefactContent'][0])
    {
        return $this->getArtefactContentAsyncWithHttpInfo($session_id, $artefact_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getArtefactContentAsyncWithHttpInfo
     *
     * Get artefact content
     *
     * @param  string $session_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getArtefactContentAsyncWithHttpInfo($session_id, $artefact_id, string $contentType = self::contentTypes['getArtefactContent'][0])
    {
        $returnType = '\FlowHunt\Model\FlowSessionArtefactContentResponse';
        $request = $this->getArtefactContentRequest($session_id, $artefact_id, $contentType);
    ...
    /**
     * Create request for operation 'getArtefactContent'
     *
     * @param  string $session_id (required)
     * @param  string $artefact_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getArtefactContent'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getArtefactContentRequest($session_id, $artefact_id, string $contentType = self::contentTypes['getArtefactContent'][0])
    {

        // verify the required parameter 'session_id' is set
        if ($session_id === null || (is_array($session_id) && count($session_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $session_id when calling getArtefactContent'
            );
        }

        // verify the required parameter 'artefact_id' is set
        if ($artefact_id === null || (is_array($artefact_id) && count($artefact_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $artefact_id when calling getArtefactContent'
            );
        }


        $resourcePath = '/v2/flows/sessions/{session_id}/artefacts/{artefact_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($artefact_id !== null) {
            $resourcePath = str_replace(
                '{' . 'artefact_id' . '}',
                ObjectSerializer::toPathValue($artefact_id),
                $resourcePath
            );
        }
    ...
    /**
     * Operation resumeHook
     *
     * Resume Hook
     *
     * @param  string $session_id session_id (required)
     * @param  \FlowHunt\Model\FlowSessionResumeHookRequest $flow_session_resume_hook_request flow_session_resume_hook_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['resumeHook'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FlowHunt\Model\Completed|\FlowHunt\Model\HTTPValidationError
     */
    public function resumeHook($session_id, $flow_session_resume_hook_request, string $contentType = self::contentTypes['resumeHook'][0])
    {
        list($response) = $this->resumeHookWithHttpInfo($session_id, $flow_session_resume_hook_request, $contentType);
        return $response;
    }

    /**
     * Operation resumeHookWithHttpInfo
     *
     * Resume Hook
     *
     * @param  string $session_id (required)
     * @param  \FlowHunt\Model\FlowSessionResumeHookRequest $flow_session_resume_hook_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['resumeHook'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FlowHunt\Model\Completed|\FlowHunt\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function resumeHookWithHttpInfo($session_id, $flow_session_resume_hook_request, string $contentType = self::contentTypes['resumeHook'][0])
    {
        $request = $this->resumeHookRequest($session_id, $flow_session_resume_hook_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resumeHookAsync($session_id, $flow_session_resume_hook_request, string $contentType = self::contentTypes['resumeHook'][0])
    {
        return $this->resumeHookAsyncWithHttpInfo($session_id, $flow_session_resume_hook_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation resumeHookAsyncWithHttpInfo
     *
     * Resume Hook
     *
     * @param  string $session_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function resumeHookAsyncWithHttpInfo($session_id, $flow_session_resume_hook_request, string $contentType = self::contentTypes['resumeHook'][0])
    {
        $returnType = '\FlowHunt\Model\Completed';
        $request = $this->resumeHookRequest($session_id, $flow_session_resume_hook_request, $contentType);
    ...
    /**
     * Create request for operation 'resumeHook'
     *
     * @param  string $session_id (required)
     * @param  \FlowHunt\Model\FlowSessionResumeHookRequest $flow_session_resume_hook_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['resumeHook'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function resumeHookRequest($session_id, $flow_session_resume_hook_request, string $contentType = self::contentTypes['resumeHook'][0])
    {

        // verify the required parameter 'session_id' is set
        if ($session_id === null || (is_array($session_id) && count($session_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $session_id when calling resumeHook'
            );
        }

        // verify the required parameter 'flow_session_resume_hook_request' is set
        if ($flow_session_resume_hook_request === null || (is_array($flow_session_resume_hook_request) && count($flow_session_resume_hook_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $flow_session_resume_hook_request when calling resumeHook'
            );
        }


        $resourcePath = '/v2/flows/sessions/{session_id}/resume-hook';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($flow_session_resume_hook_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($flow_session_resume_hook_request));
            } else {
                $httpBody = $flow_session_resume_hook_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
