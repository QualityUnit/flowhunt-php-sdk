...
class SchedulesApi
{
     ...
     * @param  string $workspace_id workspace_id (required)
     * @param  \FlowHunt\Model\ScheduleUrlDeleteRequest $schedule_url_delete_request schedule_url_delete_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteScheduleUrl'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FlowHunt\Model\Completed|\FlowHunt\Model\HTTPValidationError
     */
    public function deleteScheduleUrl($schedule_id, $url_id, $domain_id, $workspace_id, $schedule_url_delete_request, string $contentType = self::contentTypes['deleteScheduleUrl'][0])
    {
        list($response) = $this->deleteScheduleUrlWithHttpInfo($schedule_id, $url_id, $domain_id, $workspace_id, $schedule_url_delete_request, $contentType);
        return $response;
    }

    /**
     * Operation deleteScheduleUrlWithHttpInfo
     *
     * Delete Schedule Url
     *
     * @param  string $schedule_id (required)
     ...
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\ScheduleUrlDeleteRequest $schedule_url_delete_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteScheduleUrl'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FlowHunt\Model\Completed|\FlowHunt\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function deleteScheduleUrlWithHttpInfo($schedule_id, $url_id, $domain_id, $workspace_id, $schedule_url_delete_request, string $contentType = self::contentTypes['deleteScheduleUrl'][0])
    {
        $request = $this->deleteScheduleUrlRequest($schedule_id, $url_id, $domain_id, $workspace_id, $schedule_url_delete_request, $contentType);
    ...
    /**
     * Operation deleteScheduleUrlAsync
     *
     * Delete Schedule Url
     *
     * @param  string $schedule_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteScheduleUrlAsync($schedule_id, $url_id, $domain_id, $workspace_id, $schedule_url_delete_request, string $contentType = self::contentTypes['deleteScheduleUrl'][0])
    {
        return $this->deleteScheduleUrlAsyncWithHttpInfo($schedule_id, $url_id, $domain_id, $workspace_id, $schedule_url_delete_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteScheduleUrlAsyncWithHttpInfo
     *
     * Delete Schedule Url
     *
     * @param  string $schedule_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteScheduleUrlAsyncWithHttpInfo($schedule_id, $url_id, $domain_id, $workspace_id, $schedule_url_delete_request, string $contentType = self::contentTypes['deleteScheduleUrl'][0])
    {
        $returnType = '\FlowHunt\Model\Completed';
        $request = $this->deleteScheduleUrlRequest($schedule_id, $url_id, $domain_id, $workspace_id, $schedule_url_delete_request, $contentType);
    ...
    /**
     * Create request for operation 'deleteScheduleUrl'
     *
     * @param  string $schedule_id (required)
     * @param  string $url_id (required)
     * @param  string $domain_id (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteScheduleUrlRequest($schedule_id, $url_id, $domain_id, $workspace_id, $schedule_url_delete_request, string $contentType = self::contentTypes['deleteScheduleUrl'][0])
    {

        // verify the required parameter 'schedule_id' is set
        if ($schedule_id === null || (is_array($schedule_id) && count($schedule_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $schedule_id when calling deleteScheduleUrl'
            );
        }
        ...
        if ($url_id === null || (is_array($url_id) && count($url_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $url_id when calling deleteScheduleUrl'
            );
        }
        ...
        if ($domain_id === null || (is_array($domain_id) && count($domain_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $domain_id when calling deleteScheduleUrl'
            );
        }
        ...
        if ($workspace_id === null || (is_array($workspace_id) && count($workspace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $workspace_id when calling deleteScheduleUrl'
            );
        }

        // verify the required parameter 'schedule_url_delete_request' is set
        if ($schedule_url_delete_request === null || (is_array($schedule_url_delete_request) && count($schedule_url_delete_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $schedule_url_delete_request when calling deleteScheduleUrl'
            );
        }
        ...
        // for model (json/xml)
        if (isset($schedule_url_delete_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($schedule_url_delete_request));
            } else {
                $httpBody = $schedule_url_delete_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
