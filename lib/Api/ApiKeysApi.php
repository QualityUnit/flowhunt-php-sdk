...
class ApiKeysApi
{
    ...
    /**
     * Operation bulkDeleteApiKeys
     *
     * Bulk Delete Api Keys
     *
     * @param  string $workspace_id workspace_id (required)
     * @param  \FlowHunt\Model\ApiKeyBulkDeleteRequest $api_key_bulk_delete_request api_key_bulk_delete_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bulkDeleteApiKeys'] to see the possible values for this operation
     *
     ...
     */
    public function bulkDeleteApiKeys($workspace_id, $api_key_bulk_delete_request, string $contentType = self::contentTypes['bulkDeleteApiKeys'][0])
    {
        list($response) = $this->bulkDeleteApiKeysWithHttpInfo($workspace_id, $api_key_bulk_delete_request, $contentType);
        return $response;
    }

    /**
     * Operation bulkDeleteApiKeysWithHttpInfo
     *
     * Bulk Delete Api Keys
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\ApiKeyBulkDeleteRequest $api_key_bulk_delete_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bulkDeleteApiKeys'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function bulkDeleteApiKeysWithHttpInfo($workspace_id, $api_key_bulk_delete_request, string $contentType = self::contentTypes['bulkDeleteApiKeys'][0])
    {
        $request = $this->bulkDeleteApiKeysRequest($workspace_id, $api_key_bulk_delete_request, $contentType);
    ...
    /**
     * Operation bulkDeleteApiKeysAsync
     *
     * Bulk Delete Api Keys
     *
     * @param  string $workspace_id (required)
     ...
     */
    public function bulkDeleteApiKeysAsync($workspace_id, $api_key_bulk_delete_request, string $contentType = self::contentTypes['bulkDeleteApiKeys'][0])
    {
        return $this->bulkDeleteApiKeysAsyncWithHttpInfo($workspace_id, $api_key_bulk_delete_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation bulkDeleteApiKeysAsyncWithHttpInfo
     *
     * Bulk Delete Api Keys
     *
     * @param  string $workspace_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bulkDeleteApiKeysAsyncWithHttpInfo($workspace_id, $api_key_bulk_delete_request, string $contentType = self::contentTypes['bulkDeleteApiKeys'][0])
    {
    ...
    /**
     * Create request for operation 'bulkDeleteApiKeys'
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\ApiKeyBulkDeleteRequest $api_key_bulk_delete_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bulkDeleteApiKeys'] to see the possible values for this operation
     ...
     */
    public function bulkDeleteApiKeysRequest($workspace_id, $api_key_bulk_delete_request, string $contentType = self::contentTypes['bulkDeleteApiKeys'][0])
    {

        // verify the required parameter 'workspace_id' is set
        if ($workspace_id === null || (is_array($workspace_id) && count($workspace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $workspace_id when calling bulkDeleteApiKeys'
            );
        }

        // verify the required parameter 'api_key_bulk_delete_request' is set
        if ($api_key_bulk_delete_request === null || (is_array($api_key_bulk_delete_request) && count($api_key_bulk_delete_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $api_key_bulk_delete_request when calling bulkDeleteApiKeys'
            );
        }


        $resourcePath = '/v2/api_keys/delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($api_key_bulk_delete_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($api_key_bulk_delete_request));
            } else {
                $httpBody = $api_key_bulk_delete_request;
            }
    ...
    /**
     * Operation bulkUpdateApiKeys
     *
     * Bulk Update Api Keys
     *
     * @param  string $workspace_id workspace_id (required)
     * @param  \FlowHunt\Model\ApiKeyBulkUpdateRequest $api_key_bulk_update_request api_key_bulk_update_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bulkUpdateApiKeys'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FlowHunt\Model\Completed|\FlowHunt\Model\HTTPValidationError
     */
    public function bulkUpdateApiKeys($workspace_id, $api_key_bulk_update_request, string $contentType = self::contentTypes['bulkUpdateApiKeys'][0])
    {
        list($response) = $this->bulkUpdateApiKeysWithHttpInfo($workspace_id, $api_key_bulk_update_request, $contentType);
        return $response;
    }

    /**
     * Operation bulkUpdateApiKeysWithHttpInfo
     *
     * Bulk Update Api Keys
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\ApiKeyBulkUpdateRequest $api_key_bulk_update_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bulkUpdateApiKeys'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FlowHunt\Model\Completed|\FlowHunt\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function bulkUpdateApiKeysWithHttpInfo($workspace_id, $api_key_bulk_update_request, string $contentType = self::contentTypes['bulkUpdateApiKeys'][0])
    {
        $request = $this->bulkUpdateApiKeysRequest($workspace_id, $api_key_bulk_update_request, $contentType);
    ...
    /**
     * Operation bulkUpdateApiKeysAsync
     *
     * Bulk Update Api Keys
     *
     * @param  string $workspace_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bulkUpdateApiKeysAsync($workspace_id, $api_key_bulk_update_request, string $contentType = self::contentTypes['bulkUpdateApiKeys'][0])
    {
        return $this->bulkUpdateApiKeysAsyncWithHttpInfo($workspace_id, $api_key_bulk_update_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation bulkUpdateApiKeysAsyncWithHttpInfo
     *
     * Bulk Update Api Keys
     *
     * @param  string $workspace_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bulkUpdateApiKeysAsyncWithHttpInfo($workspace_id, $api_key_bulk_update_request, string $contentType = self::contentTypes['bulkUpdateApiKeys'][0])
    {
        $returnType = '\FlowHunt\Model\Completed';
        $request = $this->bulkUpdateApiKeysRequest($workspace_id, $api_key_bulk_update_request, $contentType);
    ...
    /**
     * Create request for operation 'bulkUpdateApiKeys'
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\ApiKeyBulkUpdateRequest $api_key_bulk_update_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['bulkUpdateApiKeys'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function bulkUpdateApiKeysRequest($workspace_id, $api_key_bulk_update_request, string $contentType = self::contentTypes['bulkUpdateApiKeys'][0])
    {

        // verify the required parameter 'workspace_id' is set
        if ($workspace_id === null || (is_array($workspace_id) && count($workspace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $workspace_id when calling bulkUpdateApiKeys'
            );
        }

        // verify the required parameter 'api_key_bulk_update_request' is set
        if ($api_key_bulk_update_request === null || (is_array($api_key_bulk_update_request) && count($api_key_bulk_update_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $api_key_bulk_update_request when calling bulkUpdateApiKeys'
            );
        }


        $resourcePath = '/v2/api_keys/update';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($api_key_bulk_update_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($api_key_bulk_update_request));
            } else {
                $httpBody = $api_key_bulk_update_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     *
     * @param  string $workspace_id workspace_id (required)
     * @param  \FlowHunt\Model\ApiKeyCreateRequest $api_key_create_request api_key_create_request (required)
     ...
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FlowHunt\Model\ApiKeyResponse|\FlowHunt\Model\HTTPValidationError
     */
     ...
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\ApiKeyCreateRequest $api_key_create_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createApiKey'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FlowHunt\Model\ApiKeyResponse|\FlowHunt\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\FlowHunt\Model\ApiKeyResponse';
        $request = $this->createApiKeyRequest($workspace_id, $api_key_create_request, $contentType);
     ...
     *
     * @param  string $workspace_id workspace_id (required)
     * @param  \FlowHunt\Model\ApiKeySearchRequest $api_key_search_request api_key_search_request (required)
     ...
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\ApiKeySearchRequest $api_key_search_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchApiKey'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     * @param  string $api_key_id api_key_id (required)
     * @param  string $workspace_id workspace_id (required)
     * @param  \FlowHunt\Model\ApiKeyUpdateRequest $api_key_update_request api_key_update_request (required)
     ...
     * @param  string $api_key_id (required)
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\ApiKeyUpdateRequest $api_key_update_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateApiKey'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
