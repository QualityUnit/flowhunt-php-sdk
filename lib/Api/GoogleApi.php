...
class GoogleApi
{
    ...
    /**
     * Operation getSheets_0
     *
     * Get Sheets
     *
     * @param  string $document_id document_id (required)
     * @param  string $workspace_id workspace_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSheets_0'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FlowHunt\Model\GoogleSheetsResponse|\FlowHunt\Model\HTTPValidationError
     */
    public function getSheets_0($document_id, $workspace_id, string $contentType = self::contentTypes['getSheets_0'][0])
    {
        list($response) = $this->getSheets_0WithHttpInfo($document_id, $workspace_id, $contentType);
        return $response;
    }

    /**
     * Operation getSheets_0WithHttpInfo
     *
     * Get Sheets
     *
     ...
     */
    public function getSheets_0WithHttpInfo($document_id, $workspace_id, string $contentType = self::contentTypes['getSheets_0'][0])
    {
        $request = $this->getSheets_0Request($document_id, $workspace_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSheets_0Async($document_id, $workspace_id, string $contentType = self::contentTypes['getSheets_0'][0])
    {
        return $this->getSheets_0AsyncWithHttpInfo($document_id, $workspace_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSheets_0AsyncWithHttpInfo
     *
     * Get Sheets
     *
     * @param  string $document_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSheets_0AsyncWithHttpInfo($document_id, $workspace_id, string $contentType = self::contentTypes['getSheets_0'][0])
    {
        $returnType = '\FlowHunt\Model\GoogleSheetsResponse';
        $request = $this->getSheets_0Request($document_id, $workspace_id, $contentType);
    ...
    /**
     * Create request for operation 'getSheets_0'
     *
     * @param  string $document_id (required)
     * @param  string $workspace_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSheets_0'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSheets_0Request($document_id, $workspace_id, string $contentType = self::contentTypes['getSheets_0'][0])
    {

        // verify the required parameter 'document_id' is set
        if ($document_id === null || (is_array($document_id) && count($document_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $document_id when calling getSheets_0'
            );
        }
        ...
        if ($workspace_id === null || (is_array($workspace_id) && count($workspace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $workspace_id when calling getSheets_0'
            );
        }
