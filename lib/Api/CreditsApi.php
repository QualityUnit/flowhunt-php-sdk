...
class CreditsApi
{
     ...
     * @return \FlowHunt\Model\CreditBalanceResponse
     */
     ...
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FlowHunt\Model\CreditBalanceResponse, HTTP status code, HTTP response headers (array of strings)
     */
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\FlowHunt\Model\CreditBalanceResponse',
                        $request,
                        $response,
                    );
            }
    ...
    {
        $returnType = '\FlowHunt\Model\CreditBalanceResponse';
        $request = $this->getCreditBalanceRequest($contentType);
    ...
    /**
     * Operation getDailyChartData
     *
     * Get Daily Chart Data
     *
     * @param  string $workspace_id workspace_id (required)
     * @param  \FlowHunt\Model\CreditDailyChartRequest $credit_daily_chart_request credit_daily_chart_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDailyChartData'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FlowHunt\Model\CreditDailyChartResponse|\FlowHunt\Model\HTTPValidationError
     */
    public function getDailyChartData($workspace_id, $credit_daily_chart_request, string $contentType = self::contentTypes['getDailyChartData'][0])
    {
        list($response) = $this->getDailyChartDataWithHttpInfo($workspace_id, $credit_daily_chart_request, $contentType);
        return $response;
    }

    /**
     * Operation getDailyChartDataWithHttpInfo
     *
     * Get Daily Chart Data
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\CreditDailyChartRequest $credit_daily_chart_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDailyChartData'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FlowHunt\Model\CreditDailyChartResponse|\FlowHunt\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDailyChartDataWithHttpInfo($workspace_id, $credit_daily_chart_request, string $contentType = self::contentTypes['getDailyChartData'][0])
    {
        $request = $this->getDailyChartDataRequest($workspace_id, $credit_daily_chart_request, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\FlowHunt\Model\CreditDailyChartResponse',
                        $request,
                        $response,
                    );
                case 422:
    ...
    /**
     * Operation getDailyChartDataAsync
     *
     * Get Daily Chart Data
     *
     * @param  string $workspace_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDailyChartDataAsync($workspace_id, $credit_daily_chart_request, string $contentType = self::contentTypes['getDailyChartData'][0])
    {
        return $this->getDailyChartDataAsyncWithHttpInfo($workspace_id, $credit_daily_chart_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getDailyChartDataAsyncWithHttpInfo
     *
     * Get Daily Chart Data
     *
     * @param  string $workspace_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDailyChartDataAsyncWithHttpInfo($workspace_id, $credit_daily_chart_request, string $contentType = self::contentTypes['getDailyChartData'][0])
    {
        $returnType = '\FlowHunt\Model\CreditDailyChartResponse';
        $request = $this->getDailyChartDataRequest($workspace_id, $credit_daily_chart_request, $contentType);
    ...
    /**
     * Create request for operation 'getDailyChartData'
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\CreditDailyChartRequest $credit_daily_chart_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getDailyChartData'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDailyChartDataRequest($workspace_id, $credit_daily_chart_request, string $contentType = self::contentTypes['getDailyChartData'][0])
    {

        // verify the required parameter 'workspace_id' is set
        if ($workspace_id === null || (is_array($workspace_id) && count($workspace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $workspace_id when calling getDailyChartData'
            );
        }

        // verify the required parameter 'credit_daily_chart_request' is set
        if ($credit_daily_chart_request === null || (is_array($credit_daily_chart_request) && count($credit_daily_chart_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $credit_daily_chart_request when calling getDailyChartData'
            );
        }


        $resourcePath = '/v2/credits/daily/chart';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($credit_daily_chart_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($credit_daily_chart_request));
            } else {
                $httpBody = $credit_daily_chart_request;
            }
     ...
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FlowHunt\Model\CreditBalanceResponse|\FlowHunt\Model\HTTPValidationError
     */
     ...
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FlowHunt\Model\CreditBalanceResponse|\FlowHunt\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param  string $workspace_id workspace_id (required)
     * @param  \FlowHunt\Model\CreditTransactionSearchRequest $credit_transaction_search_request credit_transaction_search_request (required)
     ...
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FlowHunt\Model\CreditTransactionResponse[]|\FlowHunt\Model\HTTPValidationError
     */
     ...
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\CreditTransactionSearchRequest $credit_transaction_search_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchCreditTransactions'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FlowHunt\Model\CreditTransactionResponse[]|\FlowHunt\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchCreditTransactionsWithHttpInfo($workspace_id, $credit_transaction_search_request, string $contentType = self::contentTypes['searchCreditTransactions'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\FlowHunt\Model\CreditTransactionResponse[]',
                        $request,
                        $response,
                    );
                case 422:
    ...
    {
        $returnType = '\FlowHunt\Model\CreditTransactionResponse[]';
        $request = $this->searchCreditTransactionsRequest($workspace_id, $credit_transaction_search_request, $contentType);
     ...
     *
     * @param  string $workspace_id workspace_id (required)
     * @param  \FlowHunt\Model\CreditDailyTransactionSearchRequest $credit_daily_transaction_search_request credit_daily_transaction_search_request (required)
     ...
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FlowHunt\Model\CreditDailyTransactionResponse[]|\FlowHunt\Model\HTTPValidationError
     */
     ...
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\CreditDailyTransactionSearchRequest $credit_daily_transaction_search_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['searchDailyCreditTransactions'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FlowHunt\Model\CreditDailyTransactionResponse[]|\FlowHunt\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchDailyCreditTransactionsWithHttpInfo($workspace_id, $credit_daily_transaction_search_request, string $contentType = self::contentTypes['searchDailyCreditTransactions'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\FlowHunt\Model\CreditDailyTransactionResponse[]',
                        $request,
                        $response,
                    );
                case 422:
    ...
    {
        $returnType = '\FlowHunt\Model\CreditDailyTransactionResponse[]';
        $request = $this->searchDailyCreditTransactionsRequest($workspace_id, $credit_daily_transaction_search_request, $contentType);
