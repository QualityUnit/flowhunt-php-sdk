...
class WorkspacesApi
{
     ...
     *
     * @param  string $workspace_id workspace_id (required)
     * @param  string $new_owner_user_id new_owner_user_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['transferWorkspaceOwnership'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FlowHunt\Model\Completed|\FlowHunt\Model\HTTPValidationError
     */
    public function transferWorkspaceOwnership($workspace_id, $new_owner_user_id, string $contentType = self::contentTypes['transferWorkspaceOwnership'][0])
    {
        list($response) = $this->transferWorkspaceOwnershipWithHttpInfo($workspace_id, $new_owner_user_id, $contentType);
        return $response;
    }

    /**
     * Operation transferWorkspaceOwnershipWithHttpInfo
     *
     * Transfer Workspace Ownership
     *
     * @param  string $workspace_id (required)
     * @param  string $new_owner_user_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['transferWorkspaceOwnership'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FlowHunt\Model\Completed|\FlowHunt\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function transferWorkspaceOwnershipWithHttpInfo($workspace_id, $new_owner_user_id, string $contentType = self::contentTypes['transferWorkspaceOwnership'][0])
    {
        $request = $this->transferWorkspaceOwnershipRequest($workspace_id, $new_owner_user_id, $contentType);
    ...
    /**
     * Operation transferWorkspaceOwnershipAsync
     *
     * Transfer Workspace Ownership
     *
     * @param  string $workspace_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function transferWorkspaceOwnershipAsync($workspace_id, $new_owner_user_id, string $contentType = self::contentTypes['transferWorkspaceOwnership'][0])
    {
        return $this->transferWorkspaceOwnershipAsyncWithHttpInfo($workspace_id, $new_owner_user_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation transferWorkspaceOwnershipAsyncWithHttpInfo
     *
     * Transfer Workspace Ownership
     *
     * @param  string $workspace_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function transferWorkspaceOwnershipAsyncWithHttpInfo($workspace_id, $new_owner_user_id, string $contentType = self::contentTypes['transferWorkspaceOwnership'][0])
    {
        $returnType = '\FlowHunt\Model\Completed';
        $request = $this->transferWorkspaceOwnershipRequest($workspace_id, $new_owner_user_id, $contentType);
    ...
    /**
     * Create request for operation 'transferWorkspaceOwnership'
     *
     * @param  string $workspace_id (required)
     * @param  string $new_owner_user_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['transferWorkspaceOwnership'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function transferWorkspaceOwnershipRequest($workspace_id, $new_owner_user_id, string $contentType = self::contentTypes['transferWorkspaceOwnership'][0])
    {

        // verify the required parameter 'workspace_id' is set
        if ($workspace_id === null || (is_array($workspace_id) && count($workspace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $workspace_id when calling transferWorkspaceOwnership'
            );
        }

        // verify the required parameter 'new_owner_user_id' is set
        if ($new_owner_user_id === null || (is_array($new_owner_user_id) && count($new_owner_user_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $new_owner_user_id when calling transferWorkspaceOwnership'
            );
        }


        $resourcePath = '/v2/workspaces/{workspace_id}/transfer-ownership/{new_owner_user_id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($new_owner_user_id !== null) {
            $resourcePath = str_replace(
                '{' . 'new_owner_user_id' . '}',
                ObjectSerializer::toPathValue($new_owner_user_id),
                $resourcePath
            );
        }
    ...
    /**
     * Operation updateWorkspaceAutoRecharge
     *
     * Update Workspace Auto Recharge
     *
     * @param  string $workspace_id workspace_id (required)
     * @param  \FlowHunt\Model\WorkspaceAutoRechargeRequest $workspace_auto_recharge_request workspace_auto_recharge_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateWorkspaceAutoRecharge'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FlowHunt\Model\WorkspaceResponse|\FlowHunt\Model\HTTPValidationError
     */
    public function updateWorkspaceAutoRecharge($workspace_id, $workspace_auto_recharge_request, string $contentType = self::contentTypes['updateWorkspaceAutoRecharge'][0])
    {
        list($response) = $this->updateWorkspaceAutoRechargeWithHttpInfo($workspace_id, $workspace_auto_recharge_request, $contentType);
        return $response;
    }

    /**
     * Operation updateWorkspaceAutoRechargeWithHttpInfo
     *
     * Update Workspace Auto Recharge
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\WorkspaceAutoRechargeRequest $workspace_auto_recharge_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateWorkspaceAutoRecharge'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FlowHunt\Model\WorkspaceResponse|\FlowHunt\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWorkspaceAutoRechargeWithHttpInfo($workspace_id, $workspace_auto_recharge_request, string $contentType = self::contentTypes['updateWorkspaceAutoRecharge'][0])
    {
        $request = $this->updateWorkspaceAutoRechargeRequest($workspace_id, $workspace_auto_recharge_request, $contentType);
    ...
    /**
     * Operation updateWorkspaceAutoRechargeAsync
     *
     * Update Workspace Auto Recharge
     *
     * @param  string $workspace_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWorkspaceAutoRechargeAsync($workspace_id, $workspace_auto_recharge_request, string $contentType = self::contentTypes['updateWorkspaceAutoRecharge'][0])
    {
        return $this->updateWorkspaceAutoRechargeAsyncWithHttpInfo($workspace_id, $workspace_auto_recharge_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateWorkspaceAutoRechargeAsyncWithHttpInfo
     *
     * Update Workspace Auto Recharge
     *
     * @param  string $workspace_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWorkspaceAutoRechargeAsyncWithHttpInfo($workspace_id, $workspace_auto_recharge_request, string $contentType = self::contentTypes['updateWorkspaceAutoRecharge'][0])
    {
        $returnType = '\FlowHunt\Model\WorkspaceResponse';
        $request = $this->updateWorkspaceAutoRechargeRequest($workspace_id, $workspace_auto_recharge_request, $contentType);
    ...
    /**
     * Create request for operation 'updateWorkspaceAutoRecharge'
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\WorkspaceAutoRechargeRequest $workspace_auto_recharge_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateWorkspaceAutoRecharge'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateWorkspaceAutoRechargeRequest($workspace_id, $workspace_auto_recharge_request, string $contentType = self::contentTypes['updateWorkspaceAutoRecharge'][0])
    {

        // verify the required parameter 'workspace_id' is set
        if ($workspace_id === null || (is_array($workspace_id) && count($workspace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $workspace_id when calling updateWorkspaceAutoRecharge'
            );
        }

        // verify the required parameter 'workspace_auto_recharge_request' is set
        if ($workspace_auto_recharge_request === null || (is_array($workspace_auto_recharge_request) && count($workspace_auto_recharge_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $workspace_auto_recharge_request when calling updateWorkspaceAutoRecharge'
            );
        }


        $resourcePath = '/v2/workspaces/{workspace_id}/auto-recharge';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($workspace_auto_recharge_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($workspace_auto_recharge_request));
            } else {
                $httpBody = $workspace_auto_recharge_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation updateWorkspaceCreditAlertThreshold
     *
     * Update Workspace Credit Alert Threshold
     *
     * @param  string $workspace_id workspace_id (required)
     * @param  \FlowHunt\Model\WorkspaceCreditAlertThresholdRequest $workspace_credit_alert_threshold_request workspace_credit_alert_threshold_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateWorkspaceCreditAlertThreshold'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FlowHunt\Model\WorkspaceResponse|\FlowHunt\Model\HTTPValidationError
     */
    public function updateWorkspaceCreditAlertThreshold($workspace_id, $workspace_credit_alert_threshold_request, string $contentType = self::contentTypes['updateWorkspaceCreditAlertThreshold'][0])
    {
        list($response) = $this->updateWorkspaceCreditAlertThresholdWithHttpInfo($workspace_id, $workspace_credit_alert_threshold_request, $contentType);
        return $response;
    }

    /**
     * Operation updateWorkspaceCreditAlertThresholdWithHttpInfo
     *
     * Update Workspace Credit Alert Threshold
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\WorkspaceCreditAlertThresholdRequest $workspace_credit_alert_threshold_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateWorkspaceCreditAlertThreshold'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FlowHunt\Model\WorkspaceResponse|\FlowHunt\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWorkspaceCreditAlertThresholdWithHttpInfo($workspace_id, $workspace_credit_alert_threshold_request, string $contentType = self::contentTypes['updateWorkspaceCreditAlertThreshold'][0])
    {
        $request = $this->updateWorkspaceCreditAlertThresholdRequest($workspace_id, $workspace_credit_alert_threshold_request, $contentType);
    ...
    /**
     * Operation updateWorkspaceCreditAlertThresholdAsync
     *
     * Update Workspace Credit Alert Threshold
     *
     * @param  string $workspace_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWorkspaceCreditAlertThresholdAsync($workspace_id, $workspace_credit_alert_threshold_request, string $contentType = self::contentTypes['updateWorkspaceCreditAlertThreshold'][0])
    {
        return $this->updateWorkspaceCreditAlertThresholdAsyncWithHttpInfo($workspace_id, $workspace_credit_alert_threshold_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateWorkspaceCreditAlertThresholdAsyncWithHttpInfo
     *
     * Update Workspace Credit Alert Threshold
     *
     * @param  string $workspace_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWorkspaceCreditAlertThresholdAsyncWithHttpInfo($workspace_id, $workspace_credit_alert_threshold_request, string $contentType = self::contentTypes['updateWorkspaceCreditAlertThreshold'][0])
    {
        $returnType = '\FlowHunt\Model\WorkspaceResponse';
        $request = $this->updateWorkspaceCreditAlertThresholdRequest($workspace_id, $workspace_credit_alert_threshold_request, $contentType);
    ...
    /**
     * Create request for operation 'updateWorkspaceCreditAlertThreshold'
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\WorkspaceCreditAlertThresholdRequest $workspace_credit_alert_threshold_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateWorkspaceCreditAlertThreshold'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateWorkspaceCreditAlertThresholdRequest($workspace_id, $workspace_credit_alert_threshold_request, string $contentType = self::contentTypes['updateWorkspaceCreditAlertThreshold'][0])
    {

        // verify the required parameter 'workspace_id' is set
        if ($workspace_id === null || (is_array($workspace_id) && count($workspace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $workspace_id when calling updateWorkspaceCreditAlertThreshold'
            );
        }

        // verify the required parameter 'workspace_credit_alert_threshold_request' is set
        if ($workspace_credit_alert_threshold_request === null || (is_array($workspace_credit_alert_threshold_request) && count($workspace_credit_alert_threshold_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $workspace_credit_alert_threshold_request when calling updateWorkspaceCreditAlertThreshold'
            );
        }


        $resourcePath = '/v2/workspaces/{workspace_id}/credit-alert-threshold';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($workspace_credit_alert_threshold_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($workspace_credit_alert_threshold_request));
            } else {
                $httpBody = $workspace_credit_alert_threshold_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation updateWorkspaceCreditLimit
     *
     * Update Workspace Credit Limit
     *
     * @param  string $workspace_id workspace_id (required)
     * @param  \FlowHunt\Model\WorkspaceCreditLimitRequest $workspace_credit_limit_request workspace_credit_limit_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateWorkspaceCreditLimit'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \FlowHunt\Model\WorkspaceResponse|\FlowHunt\Model\HTTPValidationError
     */
    public function updateWorkspaceCreditLimit($workspace_id, $workspace_credit_limit_request, string $contentType = self::contentTypes['updateWorkspaceCreditLimit'][0])
    {
        list($response) = $this->updateWorkspaceCreditLimitWithHttpInfo($workspace_id, $workspace_credit_limit_request, $contentType);
        return $response;
    }

    /**
     * Operation updateWorkspaceCreditLimitWithHttpInfo
     *
     * Update Workspace Credit Limit
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\WorkspaceCreditLimitRequest $workspace_credit_limit_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateWorkspaceCreditLimit'] to see the possible values for this operation
     *
     * @throws \FlowHunt\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \FlowHunt\Model\WorkspaceResponse|\FlowHunt\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWorkspaceCreditLimitWithHttpInfo($workspace_id, $workspace_credit_limit_request, string $contentType = self::contentTypes['updateWorkspaceCreditLimit'][0])
    {
        $request = $this->updateWorkspaceCreditLimitRequest($workspace_id, $workspace_credit_limit_request, $contentType);
    ...
    /**
     * Operation updateWorkspaceCreditLimitAsync
     *
     * Update Workspace Credit Limit
     *
     * @param  string $workspace_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWorkspaceCreditLimitAsync($workspace_id, $workspace_credit_limit_request, string $contentType = self::contentTypes['updateWorkspaceCreditLimit'][0])
    {
        return $this->updateWorkspaceCreditLimitAsyncWithHttpInfo($workspace_id, $workspace_credit_limit_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateWorkspaceCreditLimitAsyncWithHttpInfo
     *
     * Update Workspace Credit Limit
     *
     * @param  string $workspace_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWorkspaceCreditLimitAsyncWithHttpInfo($workspace_id, $workspace_credit_limit_request, string $contentType = self::contentTypes['updateWorkspaceCreditLimit'][0])
    {
        $returnType = '\FlowHunt\Model\WorkspaceResponse';
        $request = $this->updateWorkspaceCreditLimitRequest($workspace_id, $workspace_credit_limit_request, $contentType);
    ...
    /**
     * Create request for operation 'updateWorkspaceCreditLimit'
     *
     * @param  string $workspace_id (required)
     * @param  \FlowHunt\Model\WorkspaceCreditLimitRequest $workspace_credit_limit_request (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateWorkspaceCreditLimit'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateWorkspaceCreditLimitRequest($workspace_id, $workspace_credit_limit_request, string $contentType = self::contentTypes['updateWorkspaceCreditLimit'][0])
    {

        // verify the required parameter 'workspace_id' is set
        if ($workspace_id === null || (is_array($workspace_id) && count($workspace_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $workspace_id when calling updateWorkspaceCreditLimit'
            );
        }

        // verify the required parameter 'workspace_credit_limit_request' is set
        if ($workspace_credit_limit_request === null || (is_array($workspace_credit_limit_request) && count($workspace_credit_limit_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $workspace_credit_limit_request when calling updateWorkspaceCreditLimit'
            );
        }


        $resourcePath = '/v2/workspaces/{workspace_id}/credit-limit';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($workspace_credit_limit_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($workspace_credit_limit_request));
            } else {
                $httpBody = $workspace_credit_limit_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
