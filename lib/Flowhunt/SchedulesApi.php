...
class SchedulesApi
{
     ...
     */
    public function createSchedules($workspace_id, $body, string $contentType = self::contentTypes['createSchedules'][0])
    {
        list($response) = $this->createSchedulesWithHttpInfo($workspace_id, $body, $contentType);
        return $response;
    }
     ...
     */
    public function createSchedulesWithHttpInfo($workspace_id, $body, string $contentType = self::contentTypes['createSchedules'][0])
    {
        $request = $this->createSchedulesRequest($workspace_id, $body, $contentType);
     ...
     */
    public function createSchedulesAsync($workspace_id, $body, string $contentType = self::contentTypes['createSchedules'][0])
    {
        return $this->createSchedulesAsyncWithHttpInfo($workspace_id, $body, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createSchedulesAsyncWithHttpInfo($workspace_id, $body, string $contentType = self::contentTypes['createSchedules'][0])
    {
        $returnType = 'mixed';
        $request = $this->createSchedulesRequest($workspace_id, $body, $contentType);
     ...
     */
    public function createSchedulesRequest($workspace_id, $body, string $contentType = self::contentTypes['createSchedules'][0])
    {
        ...
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling createSchedules'
            );
        }
     ...
     * Delete Schedule
     *
     * @param  mixed $schedule_id schedule_id (required)
     * @param  string $workspace_id workspace_id (required)
     ...
     * Delete Schedule
     *
     * @param  mixed $schedule_id (required)
     * @param  string $workspace_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['deleteSchedule'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     ...
     *
     * @param  mixed $schedule_id schedule_id (required)
     * @param  mixed $url_id url_id (required)
     * @param  mixed $domain_id domain_id (required)
     * @param  string $workspace_id workspace_id (required)
