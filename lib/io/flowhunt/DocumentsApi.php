...
class DocumentsApi
{
     ...
     * Delete Document
     *
     * @param  mixed $doc_id doc_id (required)
     * @param  string $workspace_id workspace_id (required)
     ...
     *
     * @param  mixed $cat_id cat_id (required)
     * @param  string $workspace_id workspace_id (required)
     ...
     * Delete Faq
     *
     * @param  mixed $faq_id faq_id (required)
     * @param  string $workspace_id workspace_id (required)
